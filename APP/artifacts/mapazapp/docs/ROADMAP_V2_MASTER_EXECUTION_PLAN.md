...
- **E3.5 — IFVG Setup V1 (detección FVG):** candidatos long/short en velas cerradas, gate Daily Bias, eventos `setup_*`, summary con `has_real_ifvg_logic: true`; spec [`BACKTESTEA_IFVG_SETUP_V1_E3_5.md`](./BACKTESTEA_IFVG_SETUP_V1_E3_5.md); sin órdenes ni filas trade CSV.
