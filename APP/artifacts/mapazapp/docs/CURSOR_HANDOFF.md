...
- **Siguiente paso canónico:** **E5.5.1** — recompilar **`MZP_TestEA_E5_5_0_5`**, **MT5 Strategy Tester** (single safe-export de verificación, luego **Optimization** con **agentes locales** y **matriz pequeña**); validar cada carpeta hoja con `mapazapp:testea-export-validate`; no commitear CSV grandes.
