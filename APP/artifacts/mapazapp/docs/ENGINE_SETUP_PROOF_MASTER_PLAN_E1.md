...
| **Replay / backtest (TypeScript)** | Pipelines en `mapazapp-core` (V2-10–V2-15): **auxiliares** para tests, mock y análisis; **no** sustituyen al Strategy Tester como backtest **principal** del setup (ver **E3.1**). |
| **Import CSV / JSON** | Import en memoria y validación (V2-11 …): útil para **evidencia exportada** desde MT5/EA y fixtures; **no** define el motor principal del backtest del setup. |
