...
- **E5.5 — Runbook campaña outcome XAUUSD (docs-only):** [`XAUUSD_OUTCOME_CAMPAIGN_RUNBOOK_E5_5.md`](./XAUUSD_OUTCOME_CAMPAIGN_RUNBOOK_E5_5.md) + plantilla [`XAUUSD_OUTCOME_CAMPAIGN_REPORT_TEMPLATE_E5_5.md`](./XAUUSD_OUTCOME_CAMPAIGN_REPORT_TEMPLATE_E5_5.md). **Subpasos:** **E5.5.1** runs manuales baseline → **E5.5.2** documentar resultados → **E5.5.3** opcional forward split → **E5.5.4** compuerta decisión setup. **Siguiente:** **E5.5.1**.
