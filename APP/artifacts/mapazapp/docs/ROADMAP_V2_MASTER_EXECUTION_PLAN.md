...
- **E4.1 — Validación bundle TestEA (CLI + core) — cerrado:** [`TESTEA_EXPORT_BUNDLE_VALIDATION_E4_1.md`](./TESTEA_EXPORT_BUNDLE_VALIDATION_E4_1.md) (`mapazapp:testea-export-validate`, `validateTestEaExportBundleTexts`); sin MT5. Siguiente fase principal **E5** — campaña XAUUSD tester.
