...
- **Siguiente (decisión roadmap):** **E5.16** session/spread/volatility **o** **E5.15.2** Target Realism audit (research only).
...
- **Siguiente recomendado:** **E5.16** session/spread/volatility **o** **E5.15.2** target realism audit.
