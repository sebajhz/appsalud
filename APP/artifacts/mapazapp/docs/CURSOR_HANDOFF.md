...
- **Antes de E3.5 (IFVG):** cerrar **E3.4.1** (guía viva + roles) y **E3.4.2** (fusionar la lógica de `Mapazapp_BacktestEA` en el **`Mapazapp_TestEA` oficial**). No arrancar implementación IFVG en el EA de tester hasta esa reconciliación.
