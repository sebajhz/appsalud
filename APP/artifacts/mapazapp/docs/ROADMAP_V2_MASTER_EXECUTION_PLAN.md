...
- **E5.20.4.2 cierre bloque:** [`READONLY_CONSUMPTION_BLOCK_CLOSURE_E5_20_4_2.md`](./READONLY_CONSUMPTION_BLOCK_CLOSURE_E5_20_4_2.md). **E5.21 plan:** [`ALERT_ONLY_REVIEW_NOTIFICATIONS_PLAN_E5_21.md`](./ALERT_ONLY_REVIEW_NOTIFICATIONS_PLAN_E5_21.md). **Siguiente (post-PM):** E5.21.1.
...
- **E5.20 consumo read-only:** cerrado E5.20.4.2. **E5.21:** plan alert-only done. **Siguiente:** E5.21.1 (PM).
...
- **E5.20 alignment:** [`BRIDGEEA_DASHBOARD_READONLY_CONSUMPTION_PLAN_E5_20.md`](./BRIDGEEA_DASHBOARD_READONLY_CONSUMPTION_PLAN_E5_20.md) — E5.20 cerrado; **E5.21** plan done; implementación E5.21.x tras PM.
