...
- **Checkpoint 15 (forward-looking):** promotion/import of tester CSV into product workflows must be an **explicit approval / import path** designed in CP15+ — **no** auto-approve parameter sets from EA files alone.
