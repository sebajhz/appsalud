...
- **E5.15.2 cerrado (repo):** target realism audit — [`LIQUIDITY_TARGET_REALISM_AUDIT_E5_15_2.md`](./LIQUIDITY_TARGET_REALISM_AUDIT_E5_15_2.md); CLI `mapazapp:testea-liquidity-target-realism-audit`. **Siguiente:** **E5.15.3** evidencia operador post-audit **o** **E5.16** session/spread/volatility. **Futuro:** Setup Readiness Checklist (North Star E5.18).
