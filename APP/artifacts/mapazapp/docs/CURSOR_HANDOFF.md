...
- **Siguiente paso canónico:** **E5.10.2** — **Liquidity Sweep Quality Refinement** (mejorar discriminación de calidad; sin compuerta dura hasta nueva evidencia); reconciliar IDs con contrato §13 y **E5.5.2** §15. **Nota:** el track opcional **`tester_orders`** (E5.1) queda **aparte**.
