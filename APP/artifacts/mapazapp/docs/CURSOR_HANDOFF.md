...
**Roadmap V2-05 — Decision model / soft-score:** `evaluateDecisionModel` + replay trace fields (`decisionModelResult`, `effectiveScoreForReplay`, `legacyDefaultScore`); see `APP/artifacts/mapazapp/docs/V2_05_DECISION_MODEL_SOFT_SCORE_REDESIGN.md`. Next engine step suggested: **V2-06** human-like tolerance calibration (renumbered in `CP18_5_FINAL_AUDIT_AND_ROADMAP_V2.md`).
