...
**E5.22:** evidencia PASS — export SET001 refrescado ([`LATEST_TESTEA_MT5_ST_EVIDENCE_E5_22.md`](./LATEST_TESTEA_MT5_ST_EVIDENCE_E5_22.md)). Casebook sigue sin MQL5 hasta **E5.22.4**. Cursor **no** inventa reglas fuera de los casos definidos aquí.
