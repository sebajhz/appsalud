...
| E5.9.1 | Score calibration **operator evidence** (docs; CLI runs) | **completed** | Operador + Cursor | Smoke E5.8.1; JSON post–E5.9.0.1; decisión sin gate — [`ENTRY_QUALITY_SCORE_CALIBRATION_EVIDENCE_E5_9_1.md`](./ENTRY_QUALITY_SCORE_CALIBRATION_EVIDENCE_E5_9_1.md); sin commit CSV. | **E5.10+** |
...
| E5.9.1 | Score calibration evidence (operator CLI smoke E5.8.1) | `ENTRY_QUALITY_SCORE_CALIBRATION_EVIDENCE_E5_9_1.md`, refs guía/handoff/roadmap/contrato/export/smoke | PASS evidencia; sin gate; roadmap E5.10+ componentes | **E5.10+** implementación |
