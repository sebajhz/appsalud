...
- **E5.4.1 — Fix geometría / deinit / validadores (repo) — cerrado:** mismo doc — `MZP_TestEA_E5_4_1`, sin MT5 en CI. **Siguiente:** **E5.4.2** — repetir smoke Strategy Tester con build E5.4.1.
