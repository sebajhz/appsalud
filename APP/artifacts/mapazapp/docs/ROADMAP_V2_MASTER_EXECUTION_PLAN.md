...
- **E5.20.4 mock HTML:** [`DASHBOARD_READONLY_MOCK_E5_20_4.md`](./DASHBOARD_READONLY_MOCK_E5_20_4.md). **Siguiente:** E5.20.4.1 evidencia operador.
...
- **E5.20.3 / E5.20.3.1:** adaptador + evidencia PASS. **E5.20.4:** mock HTML read-only — [`DASHBOARD_READONLY_MOCK_E5_20_4.md`](./DASHBOARD_READONLY_MOCK_E5_20_4.md). **Siguiente:** E5.20.4.1 evidencia operador / E5.20.5 revisión PM.
...
- **E5.20 alignment:** [`BRIDGEEA_DASHBOARD_READONLY_CONSUMPTION_PLAN_E5_20.md`](./BRIDGEEA_DASHBOARD_READONLY_CONSUMPTION_PLAN_E5_20.md) — **E5.20.4** mock HTML done; **E5.20.4.1** evidencia siguiente.
