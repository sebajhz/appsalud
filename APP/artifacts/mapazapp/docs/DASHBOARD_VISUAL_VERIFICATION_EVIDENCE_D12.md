...
**Segundo intento (D12.8, commit `0f1362a`):** mismo patrón de evidencia **parcial** por agente (HTTP/CORS/logs/cleanup **OK**). Evidencia formal intermedia: [`DASHBOARD_VISUAL_VERIFICATION_RUN_EVIDENCE_D12.md`](./DASHBOARD_VISUAL_VERIFICATION_RUN_EVIDENCE_D12.md) (**D12.9**). **Cierre visual humano** sobre esa línea: **D12.10** + evidencia **D12.11** en [`HUMAN_DASHBOARD_VISUAL_VERIFICATION_EVIDENCE_D12.md`](./HUMAN_DASHBOARD_VISUAL_VERIFICATION_EVIDENCE_D12.md).
