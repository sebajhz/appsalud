...
- Siguiente planificado: V2-12 (validacion de muestras reales saneadas).
...
**Roadmap V2-11 — Manual candle dataset import:** `importManualCandleDataset` + `createBacktestCampaignDatasetFromManualImport`; see `APP/artifacts/mapazapp/docs/V2_11_MANUAL_CANDLE_DATASET_IMPORT.md`. Further items per `ROADMAP_V2_MASTER_EXECUTION_PLAN.md` (e.g. V2-12 sample validation).
