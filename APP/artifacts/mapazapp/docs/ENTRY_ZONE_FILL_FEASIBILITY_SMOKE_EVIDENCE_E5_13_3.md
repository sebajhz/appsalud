...
**Siguiente recomendado (histórico):** **E5.13.5** — cerrado — [`ENTRY_VARIANT_FEASIBILITY_SMOKE_EVIDENCE_E5_13_5.md`](./ENTRY_VARIANT_FEASIBILITY_SMOKE_EVIDENCE_E5_13_5.md). **E5.13.4** en repo — [`ENTRY_VARIANT_FEASIBILITY_AUDIT_E5_13_4.md`](./ENTRY_VARIANT_FEASIBILITY_AUDIT_E5_13_4.md). **Checkpoint actual:** **E5.13.6** Entry Variant Outcome / Risk Simulation.
