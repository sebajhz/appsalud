# Mapazapp_TestEA — Official Strategy Tester EA (E3.6–E5.10.2)
...
2. Compile in **MetaEditor** (F7) as **`MZP_TestEA_E5_10_2`**.
...
- **Compile** build **`MZP_TestEA_E5_10_2`** (see `TESTEA_BUILD` in `Mapazapp_TestEA.mq5`).
