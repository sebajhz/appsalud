...
- **E5.7 cerrado (docs-only):** contrato **Entry Quality Score V1** — observación primero; siete componentes (100 pt provisionales); métricas de campaña E5.9; export futuro; sin compuerta dura ni código — [`ENTRY_QUALITY_SCORE_CONTRACT_E5_7.md`](./ENTRY_QUALITY_SCORE_CONTRACT_E5_7.md).
