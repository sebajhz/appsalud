...
**Roadmap V2-09 — Target / liquidity objective:** `evaluateTargetObjective` + optional `DecisionModelInput.targetObjectiveResult` + optional `EntrySlTpModelInput.targetObjectiveResult`; see `APP/artifacts/mapazapp/docs/V2_09_TARGET_LIQUIDITY_OBJECTIVE_MODEL.md`. Further roadmap items per `CP18_5_FINAL_AUDIT_AND_ROADMAP_V2.md` (e.g. V2-10 symbol-ranking campaign) remain separate.
