...
- **E5.4.3 — Evidencia + política build/versioning TestEA (docs-only):** [`TESTEA_BUILD_VERSIONING_POLICY_E5_4_3.md`](./TESTEA_BUILD_VERSIONING_POLICY_E5_4_3.md). **Siguiente:** **E5.5** — campaña XAUUSD con métricas de outcome.
