...
- **E5.15.4 (policy):** [`TARGET_POLICY_RESEARCH_E5_15_4.md`](./TARGET_POLICY_RESEARCH_E5_15_4.md).
...
- **E5.18.1 (smoke):** [`SETUP_READINESS_CHECKLIST_SMOKE_EVIDENCE_E5_18_1.md`](./SETUP_READINESS_CHECKLIST_SMOKE_EVIDENCE_E5_18_1.md) — PASS; caveat grade A + reject.
- **E5.18.2 (repo):** [`SETUP_READINESS_DECISION_CALIBRATION_AUDIT_E5_18_2.md`](./SETUP_READINESS_DECISION_CALIBRATION_AUDIT_E5_18_2.md).
- **E5.18.3 (evidencia):** [`SETUP_READINESS_DECISION_CALIBRATION_AUDIT_EVIDENCE_E5_18_3.md`](./SETUP_READINESS_DECISION_CALIBRATION_AUDIT_EVIDENCE_E5_18_3.md) — PASS.
...
- **E5.22.0.1 (docs-only):** [`MT5_REPO_STRATEGY_ALIGNMENT_CHECK_E5_22_0_1.md`](./MT5_REPO_STRATEGY_ALIGNMENT_CHECK_E5_22_0_1.md) — alineación MT5/repo.
- **E5.22 (evidencia PASS):** [`LATEST_TESTEA_MT5_ST_EVIDENCE_E5_22.md`](./LATEST_TESTEA_MT5_ST_EVIDENCE_E5_22.md).
...
- **E5.22.4.1 (example selector):** evidencia **PASS** [`HUMANIZED_CASEBOOK_EXAMPLE_SELECTOR_EVIDENCE_E5_22_4_1.md`](./HUMANIZED_CASEBOOK_EXAMPLE_SELECTOR_EVIDENCE_E5_22_4_1.md).
- **E5.22.4.2 (trade cards):** [`HUMANIZED_TEXTUAL_TRADE_CARDS_E5_22_4_2.md`](./HUMANIZED_TEXTUAL_TRADE_CARDS_E5_22_4_2.md).
- **E5.22.5 (trade-set delta):** [`HUMANIZED_ACCEPTANCE_TRADE_SET_DELTA_DESIGN_E5_22_5.md`](./HUMANIZED_ACCEPTANCE_TRADE_SET_DELTA_DESIGN_E5_22_5.md).
- **E5.23 (optimization governance):** [`OPTIMIZATION_GOVERNANCE_SYMBOL_PROFILES_E5_23.md`](./OPTIMIZATION_GOVERNANCE_SYMBOL_PROFILES_E5_23.md). **E5.23.1–23.4:** perfil · matriz · carpetas · WF template. **E5.24:** [`XAUUSD_M15_ROBUSTNESS_CAMPAIGN_PLAN_E5_24.md`](./XAUUSD_M15_ROBUSTNESS_CAMPAIGN_PLAN_E5_24.md). **E5.24.1.4:** [`CONFIRMED_ROBUSTNESS_DATE_RANGES_E5_24_1_4.md`](./CONFIRMED_ROBUSTNESS_DATE_RANGES_E5_24_1_4.md) — **cerrado (docs)**. **Siguiente:** E5.24.2 SET002 OOS ST.
...
| E5.15.2 | **Target realism audit** | **completed** | TS research | [`LIQUIDITY_TARGET_REALISM_AUDIT_E5_15_2.md`](./LIQUIDITY_TARGET_REALISM_AUDIT_E5_15_2.md). | **E5.15.3** |
| E5.15.3 | **Target realism audit evidence** | **completed** | Operator + docs | PASS — [`LIQUIDITY_TARGET_REALISM_AUDIT_EVIDENCE_E5_15_3.md`](./LIQUIDITY_TARGET_REALISM_AUDIT_EVIDENCE_E5_15_3.md). | **E5.15.4** |
| E5.15.4 | **Target policy research** | **completed** | Docs only | [`TARGET_POLICY_RESEARCH_E5_15_4.md`](./TARGET_POLICY_RESEARCH_E5_15_4.md). | **E5.16** |
| E5.16 | **Session / spread / volatility export** | **completed** | MQL5 + TS | [`SESSION_SPREAD_VOLATILITY_EXPORT_E5_16.md`](./SESSION_SPREAD_VOLATILITY_EXPORT_E5_16.md). | **E5.16.1** |
| E5.16.1 | **Session / spread / volatility smoke** | **completed** | Operator + docs | PASS — [`SESSION_SPREAD_VOLATILITY_SMOKE_EVIDENCE_E5_16_1.md`](./SESSION_SPREAD_VOLATILITY_SMOKE_EVIDENCE_E5_16_1.md). | **E5.16.2** |
| E5.16.2 | **Execution environment calibration audit** | **completed** | TS research | [`EXECUTION_ENVIRONMENT_CALIBRATION_AUDIT_E5_16_2.md`](./EXECUTION_ENVIRONMENT_CALIBRATION_AUDIT_E5_16_2.md). | **E5.16.3** |
...
| E5.18.1 | **Checklist smoke evidence** | **completed** | Operator ST | [`SETUP_READINESS_CHECKLIST_SMOKE_EVIDENCE_E5_18_1.md`](./SETUP_READINESS_CHECKLIST_SMOKE_EVIDENCE_E5_18_1.md); SET001 PASS. | **E5.18.6+** |
| E5.18.2 | **Decision calibration audit (repo)** | **completed** | TS CLI | [`SETUP_READINESS_DECISION_CALIBRATION_AUDIT_E5_18_2.md`](./SETUP_READINESS_DECISION_CALIBRATION_AUDIT_E5_18_2.md). | **E5.18.6+** |
| E5.18.3 | **Calibration audit evidence** | **completed** | Operator CLI | [`SETUP_READINESS_DECISION_CALIBRATION_AUDIT_EVIDENCE_E5_18_3.md`](./SETUP_READINESS_DECISION_CALIBRATION_AUDIT_EVIDENCE_E5_18_3.md); PASS. | **E5.18.6+** |
| E5.18.4 | **Decision policy refinement** | **completed** | Docs | [`SETUP_READINESS_DECISION_POLICY_REFINEMENT_E5_18_4.md`](./SETUP_READINESS_DECISION_POLICY_REFINEMENT_E5_18_4.md). | **E5.18.6+** |
| E5.18.5 | **Dashboard/report contract** | **completed** | Docs | [`SETUP_READINESS_DASHBOARD_REPORT_CONTRACT_E5_18_5.md`](./SETUP_READINESS_DASHBOARD_REPORT_CONTRACT_E5_18_5.md). | **E5.19** |
| E5.19 | **Report prototype (CLI)** | **completed** | TS CLI | [`SETUP_READINESS_REPORT_PROTOTYPE_E5_19.md`](./SETUP_READINESS_REPORT_PROTOTYPE_E5_19.md). | **E5.19.0.1** |
| E5.19.0.1 | **Report CLI operator UX** | **completed** | TS CLI | Sin MQL5; `header.bundle`, import metadata, `--verbose`. | **E5.19.1** |
| E5.19.1 | **Report prototype evidence** | **completed** | Docs | [`SETUP_READINESS_REPORT_PROTOTYPE_EVIDENCE_E5_19_1.md`](./SETUP_READINESS_REPORT_PROTOTYPE_EVIDENCE_E5_19_1.md); PASS SET001. | **E5.19.2** |
| E5.19.2 | **Report UX polish** | **completed** | TS | [`SETUP_READINESS_REPORT_UX_POLISH_E5_19_2.md`](./SETUP_READINESS_REPORT_UX_POLISH_E5_19_2.md); presentación only. | **E5.19.3** |
| E5.19.3 | **Report UX polish evidence** | **completed** | Docs | [`SETUP_READINESS_REPORT_UX_POLISH_EVIDENCE_E5_19_3.md`](./SETUP_READINESS_REPORT_UX_POLISH_EVIDENCE_E5_19_3.md); PASS SET001 polished. | **E5.20** |
| E5.20 | **BridgeEA / dashboard read-only consumption plan** | **completed (docs)** | Docs | [`BRIDGEEA_DASHBOARD_READONLY_CONSUMPTION_PLAN_E5_20.md`](./BRIDGEEA_DASHBOARD_READONLY_CONSUMPTION_PLAN_E5_20.md) | E5.20.1 |
...
| E5.20.3.0.2 | **Persisted JSON decision_summary campaign counts** | **completed** | TS | `decision_summary` ≠ `trade_cards`; tests CLI persistido | E5.20.3.1 |
| E5.20.3.1 | **Dashboard adapter operator evidence** | **completed (PASS)** | Docs | [`DASHBOARD_READONLY_ADAPTER_EVIDENCE_E5_20_3_1.md`](./DASHBOARD_READONLY_ADAPTER_EVIDENCE_E5_20_3_1.md) | E5.20.4 |
| E5.20.4 | **Dashboard read-only mock HTML** | **completed** | TS CLI | [`DASHBOARD_READONLY_MOCK_E5_20_4.md`](./DASHBOARD_READONLY_MOCK_E5_20_4.md) | E5.20.4.1 |
| E5.20.4.1 | **Dashboard mock operator evidence** | **completed (PASS)** | Docs | [`DASHBOARD_READONLY_MOCK_EVIDENCE_E5_20_4_1.md`](./DASHBOARD_READONLY_MOCK_EVIDENCE_E5_20_4_1.md) | E5.20.4.2 |
| E5.20.4.2 | **Read-only consumption block closure** | **completed (closed)** | Docs | [`READONLY_CONSUMPTION_BLOCK_CLOSURE_E5_20_4_2.md`](./READONLY_CONSUMPTION_BLOCK_CLOSURE_E5_20_4_2.md) | E5.21 |
| E5.21 | **Alert-only review notifications plan** | **completed (docs)** | Docs | [`ALERT_ONLY_REVIEW_NOTIFICATIONS_PLAN_E5_21.md`](./ALERT_ONLY_REVIEW_NOTIFICATIONS_PLAN_E5_21.md) | E5.21.1 |
...
| E5.21.2.2 | **Engine-first roadmap realignment** | **completed (docs)** | Docs | [`ENGINE_FIRST_ROADMAP_REALIGNMENT_AND_NEXT_STEPS_E5_21_2_2.md`](./ENGINE_FIRST_ROADMAP_REALIGNMENT_AND_NEXT_STEPS_E5_21_2_2.md) | E5.22.0.1 |
| E5.22.0.1 | **MT5 / repo / strategy alignment check** | **completed (docs)** | Docs | [`MT5_REPO_STRATEGY_ALIGNMENT_CHECK_E5_22_0_1.md`](./MT5_REPO_STRATEGY_ALIGNMENT_CHECK_E5_22_0_1.md) | E5.22 |
| E5.22 | **Latest TestEA compile + ST evidence refresh** | **completed (PASS)** | Operador + docs | [`LATEST_TESTEA_MT5_ST_EVIDENCE_E5_22.md`](./LATEST_TESTEA_MT5_ST_EVIDENCE_E5_22.md) | E5.22.2 |
...
| E5.22.4.1 | **Humanized casebook example selector** | **completed (repo + evidence PASS)** | Core + CLI | [`HUMANIZED_CASEBOOK_EXAMPLE_SELECTOR_EVIDENCE_E5_22_4_1.md`](./HUMANIZED_CASEBOOK_EXAMPLE_SELECTOR_EVIDENCE_E5_22_4_1.md) | E5.22.4.2 |
| E5.22.4.2 | **Humanized textual trade cards** | **completed (docs)** | Docs | [`HUMANIZED_TEXTUAL_TRADE_CARDS_E5_22_4_2.md`](./HUMANIZED_TEXTUAL_TRADE_CARDS_E5_22_4_2.md) | E5.22.5 |
| E5.22.5 | **Humanized trade-set delta design** | **completed (docs)** | Docs | [`HUMANIZED_ACCEPTANCE_TRADE_SET_DELTA_DESIGN_E5_22_5.md`](./HUMANIZED_ACCEPTANCE_TRADE_SET_DELTA_DESIGN_E5_22_5.md) | E5.22.5.1 |
| E5.23 | **Optimization governance / symbol profiles** | **completed (docs)** | Docs | [`OPTIMIZATION_GOVERNANCE_SYMBOL_PROFILES_E5_23.md`](./OPTIMIZATION_GOVERNANCE_SYMBOL_PROFILES_E5_23.md) | E5.24.2 |
| E5.23.1 | **XAUUSD M15 Profile V1** | **completed (docs)** | Docs | [`XAUUSD_M15_PROFILE_V1_E5_23_1.md`](./XAUUSD_M15_PROFILE_V1_E5_23_1.md) | E5.24.2 |
| E5.23.2 | **SET001 optimization comparison matrix** | **completed (docs)** | Docs | [`SET001_OPTIMIZATION_COMPARISON_MATRIX_DESIGN_E5_23_2.md`](./SET001_OPTIMIZATION_COMPARISON_MATRIX_DESIGN_E5_23_2.md) | E5.24.2 |
| E5.23.3 | **Multi-bundle / OOS campaign folders** | **completed (docs)** | Docs | [`MULTI_BUNDLE_OOS_CAMPAIGN_FOLDER_CONTRACT_E5_23_3.md`](./MULTI_BUNDLE_OOS_CAMPAIGN_FOLDER_CONTRACT_E5_23_3.md) | E5.24.2 |
| E5.23.4 | **Walk-forward evidence template** | **completed (docs)** | Docs | [`WALK_FORWARD_CAMPAIGN_EVIDENCE_TEMPLATE_E5_23_4.md`](./WALK_FORWARD_CAMPAIGN_EVIDENCE_TEMPLATE_E5_23_4.md) | E5.24.2 |
| E5.24 | **XAUUSD robustness campaign plan** | **completed (plan docs)** | Docs | [`XAUUSD_M15_ROBUSTNESS_CAMPAIGN_PLAN_E5_24.md`](./XAUUSD_M15_ROBUSTNESS_CAMPAIGN_PLAN_E5_24.md) | E5.24.2 |
| E5.24.1 | **Robustness date ranges confirmation** | **completed (docs)** | Docs | [`XAUUSD_M15_ROBUSTNESS_DATE_RANGES_E5_24_1.md`](./XAUUSD_M15_ROBUSTNESS_DATE_RANGES_E5_24_1.md) | E5.24.2 |
| E5.24.1.1 | **SET001 observed trade range** | **completed (docs)** | Docs | [`SET001_OBSERVED_TRADE_RANGE_E5_24_1_1.md`](./SET001_OBSERVED_TRADE_RANGE_E5_24_1_1.md) | E5.24.1.3 |
| E5.24.1.2 | **Robustness recut split decision** | **completed (docs)** | Docs | [`ROBUSTNESS_RECUT_DATE_SPLIT_DECISION_E5_24_1_2.md`](./ROBUSTNESS_RECUT_DATE_SPLIT_DECISION_E5_24_1_2.md) | E5.24.2 |
| E5.24.1.3 | **Proposed robustness date splits** | **completed (docs)** | Docs | [`PROPOSED_ROBUSTNESS_DATE_SPLITS_E5_24_1_3.md`](./PROPOSED_ROBUSTNESS_DATE_SPLITS_E5_24_1_3.md) | E5.24.2 |
| E5.24.1.4 | **Confirmed robustness date ranges** | **completed (docs)** | Docs | [`CONFIRMED_ROBUSTNESS_DATE_RANGES_E5_24_1_4.md`](./CONFIRMED_ROBUSTNESS_DATE_RANGES_E5_24_1_4.md) | E5.24.2 |
...
**Humanización sí es** criterio discrecional tipo trader: near-miss, accept/wait/reject/observe/no-trade, setup incompleto pero operable vs válido pero skip, contexto sesión/noticias/volatilidad/disciplina sin filtros mecánicos rígidos por defecto. Política V1: [`HUMANIZED_SETUP_ACCEPTANCE_POLICY_V1_E5_20_5.md`](./HUMANIZED_SETUP_ACCEPTANCE_POLICY_V1_E5_20_5.md). Casos V1: [`HUMANIZED_ACCEPTANCE_CASEBOOK_E5_20_6.md`](./HUMANIZED_ACCEPTANCE_CASEBOOK_E5_20_6.md) (HA-001 … HA-010).
