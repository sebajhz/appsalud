...
- **Siguiente paso canónico:** **E5.13 — Premium/Discount V1** — roadmap [`PROFESSIONAL_TRADER_HUMANIZATION_ROADMAP_E5_11.md`](./PROFESSIONAL_TRADER_HUMANIZATION_ROADMAP_E5_11.md) §D. **Nota:** el track opcional **`tester_orders`** (E5.1) queda **aparte**.
