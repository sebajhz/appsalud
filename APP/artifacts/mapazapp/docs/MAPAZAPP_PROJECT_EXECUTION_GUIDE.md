...
- **Siguiente operativo:** **E5.12.1 — MSS / CHoCH smoke evidence** (operador; post–**E5.12** export `MZP_TestEA_E5_12`) — referencia [`MSS_CHOCH_EXPORT_E5_12.md`](./MSS_CHOCH_EXPORT_E5_12.md). Cadena liquidez/reacción, HTF Structure y MSS/CHoCH permanecen observación-only (sin compuerta dura ni live). Componentes de score históricos: **E5.9.1** §12; reconciliar numeración con audit §15.
...
| Humanización roadmap | Roadmap intermedio trader profesional E5.11–E5.19 (docs-only) | `PROFESSIONAL_TRADER_HUMANIZATION_ROADMAP_E5_11.md`, refs `ROADMAP_V2_MASTER_EXECUTION_PLAN.md`, `CURSOR_HANDOFF.md`, evidencias E5.10.7 / **E5.11.1** | Secuencia observación-first; E5.11 export + smoke cerrados en docs | **E5.12** MSS/CHoCH |
