...
**Build TestEA:** `MZP_TestEA_E5_12_2` (`#define TESTEA_BUILD`) — incluye **Liquidity Sweep V1 + Quality V1 + Causal Liquidity Chain V1 + E5.10.6 reaction audit + E5.11 HTF Structure V1 + E5.12 MSS/CHoCH V1 + E5.12.2 temporal relevance diagnostics** observación/export; ver [`LIQUIDITY_SWEEP_DETECTION_EXPORT_E5_10.md`](./LIQUIDITY_SWEEP_DETECTION_EXPORT_E5_10.md), [`LIQUIDITY_SWEEP_QUALITY_REFINEMENT_E5_10_2.md`](./LIQUIDITY_SWEEP_QUALITY_REFINEMENT_E5_10_2.md), [`LIQUIDITY_CHAIN_REFINEMENT_E5_10_4.md`](./LIQUIDITY_CHAIN_REFINEMENT_E5_10_4.md), [`LIQUIDITY_CHAIN_REACTION_AUDIT_E5_10_6.md`](./LIQUIDITY_CHAIN_REACTION_AUDIT_E5_10_6.md), [`HTF_STRUCTURE_EXPORT_E5_11.md`](./HTF_STRUCTURE_EXPORT_E5_11.md), [`MSS_CHOCH_EXPORT_E5_12.md`](./MSS_CHOCH_EXPORT_E5_12.md), [`MSS_CHOCH_TEMPORAL_RELEVANCE_AUDIT_E5_12_2.md`](./MSS_CHOCH_TEMPORAL_RELEVANCE_AUDIT_E5_12_2.md).  
...
|------------|-------------|--------|
| **HTF narrative** | **E5.11 (HTF Structure V1)** | Cuando HTF Structure está habilitado y el score HTF está activo para EQ, **`htf_narrative_score`** refleja **`htf_structure_score`** (0–20) y razones exportadas; si los flags están off, puede mantenerse el comportamiento legacy / marcadores en `missing_quality_components`. Detalle: [`HTF_STRUCTURE_EXPORT_E5_11.md`](./HTF_STRUCTURE_EXPORT_E5_11.md). |
...
| E5.13.2 | Entry Fill Feasibility V1 (**post-candidato**; no forma parte de `entry_quality_score`); ver [`ENTRY_ZONE_FILL_FEASIBILITY_AUDIT_E5_13_2.md`](./ENTRY_ZONE_FILL_FEASIBILITY_AUDIT_E5_13_2.md). |
| E5.13.4 | Entry Variant Feasibility V1 (**hipotético**; columnas `entry_variant_*` separadas; no forma parte de `entry_quality_score`); ver [`ENTRY_VARIANT_FEASIBILITY_AUDIT_E5_13_4.md`](./ENTRY_VARIANT_FEASIBILITY_AUDIT_E5_13_4.md). |
