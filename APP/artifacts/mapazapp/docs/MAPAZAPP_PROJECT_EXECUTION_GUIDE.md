...
- **Siguiente operativo:** **E5.10.7** — smoke Strategy Tester post–**E5.10.6**: recompilar `MZP_TestEA_E5_10_6`, mismo smoke **XAUUSD M15/D1**, validar bundle por CLI, revisar `liquidity_chain_reaction_confirmed_count`, `liquidity_chain_reaction_failure_reason`, contadores `liquidity_chain_reaction_fail_*` y score/outcome solo como observación; ver [`LIQUIDITY_CHAIN_REACTION_AUDIT_E5_10_6.md`](./LIQUIDITY_CHAIN_REACTION_AUDIT_E5_10_6.md). **Roadmap intermedio humanización trader (E5.11–E5.19):** [`PROFESSIONAL_TRADER_HUMANIZATION_ROADMAP_E5_11.md`](./PROFESSIONAL_TRADER_HUMANIZATION_ROADMAP_E5_11.md) — secuencia HTF → liquidez → reacción → desplazamiento → FVG/IFVG → confirmación → entrada → invalidación → objetivo → controles; invariantes de ingeniería en ese doc. Componentes de score históricos: **E5.9.1** §12; reconciliar numeración con audit §15.
...
| E5.9.1 | Score calibration **operator evidence** (docs; CLI runs) | **completed** | Operador + Cursor | Smoke E5.8.1; JSON post–E5.9.0.1; decisión sin gate — [`ENTRY_QUALITY_SCORE_CALIBRATION_EVIDENCE_E5_9_1.md`](./ENTRY_QUALITY_SCORE_CALIBRATION_EVIDENCE_E5_9_1.md); sin commit CSV. | **E5.10.7** |
| E5.10.7 | Liquidity Chain Reaction **smoke evidence** (operator; post–E5.10.6) | **pending** | Operador humano | Recompilar `MZP_TestEA_E5_10_6`; smoke **XAUUSD M15/D1**; validación bundle CLI; `liquidity_chain_reaction_*` por outcome; decisión balance heurística — [`LIQUIDITY_CHAIN_REACTION_AUDIT_E5_10_6.md`](./LIQUIDITY_CHAIN_REACTION_AUDIT_E5_10_6.md); siguiente capacidades humanización — [`PROFESSIONAL_TRADER_HUMANIZATION_ROADMAP_E5_11.md`](./PROFESSIONAL_TRADER_HUMANIZATION_ROADMAP_E5_11.md). | |
...
| E5.9.1 | Score calibration evidence (operator CLI smoke E5.8.1) | `ENTRY_QUALITY_SCORE_CALIBRATION_EVIDENCE_E5_9_1.md`, refs guía/handoff/roadmap/contrato/export/smoke | PASS evidencia; sin gate; cadena liquidez E5.10.x; humanización E5.11–E5.19 en doc dedicado | **E5.10.7** smoke |
| Humanización roadmap | Roadmap intermedio trader profesional E5.11–E5.19 (docs-only) | `PROFESSIONAL_TRADER_HUMANIZATION_ROADMAP_E5_11.md`, refs `ROADMAP_V2_MASTER_EXECUTION_PLAN.md`, `CURSOR_HANDOFF.md`, `LIQUIDITY_CHAIN_REACTION_AUDIT_E5_10_6.md` §E5.10.7 | Secuencia observación-first documentada antes de más implementación | **E5.10.7** operador |
