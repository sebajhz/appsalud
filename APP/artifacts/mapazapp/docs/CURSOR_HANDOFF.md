...
**Roadmap V2-06 — Human-like tolerance calibration:** `evaluateToleranceCalibration` + optional `DecisionModelInput.toleranceCalibrationResult` / `toleranceIntegration`; see `APP/artifacts/mapazapp/docs/V2_06_HUMAN_LIKE_TOLERANCE_CALIBRATION.md`. Next engine step suggested: **V2-07** HTF bias / context engine v1 (per `CP18_5_FINAL_AUDIT_AND_ROADMAP_V2.md`).
