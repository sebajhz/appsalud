...
- **E5.9 cerrado (repo):** analizador **calibración/distribución** del score (`testea-score-calibration.ts`, CLI `mapazapp:testea-score-calibration`, tests) — [`ENTRY_QUALITY_SCORE_CALIBRATION_ANALYZER_E5_9.md`](./ENTRY_QUALITY_SCORE_CALIBRATION_ANALYZER_E5_9.md).
- **Siguiente paso canónico:** **E5.9.1** — evidencia operador (CLI sobre bundles smoke/campaña); **E5.10**–**E5.13** en audit/roadmap. **Nota:** el track opcional **`tester_orders`** (E5.1) queda **aparte** — ver **E5.5.2** §15.
