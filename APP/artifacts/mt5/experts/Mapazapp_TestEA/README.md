# Mapazapp_TestEA — Official Strategy Tester EA (E3.5+)
...
**Next:** E3.6 export/evidence schema finalization, or E4 first manual Strategy Tester smoke when approved.
