# Mapazapp_TestEA — Official Strategy Tester EA (E3.6–E5.10.6)
...
| **Liquidity sweep (E5.10–E5.10.6)** | **Observation-only** PDH/PDL + local M15 sweep **context**; **E5.10.2** **Quality V1** (`liquidity_sweep_quality_*`); **E5.10.2.1** reasons + caps; **E5.10.4** causal chain (`liquidity_chain_*`, **`has_liquidity_chain_v1_logic`**); **E5.10.6** reaction audit diagnostics (`liquidity_chain_reaction_*`, **`has_liquidity_chain_reaction_audit_v1_logic`**); **`liquidity_event_score`** uses **chain score** when the chain qualifies, else capped raw-quality when scoring enabled; **`has_liquidity_sweep_v1_logic`** + **`has_liquidity_sweep_quality_v1_logic`**; **no** hard gate — [`LIQUIDITY_SWEEP_DETECTION_EXPORT_E5_10.md`](../../../mapazapp/docs/LIQUIDITY_SWEEP_DETECTION_EXPORT_E5_10.md), [`LIQUIDITY_SWEEP_QUALITY_REFINEMENT_E5_10_2.md`](../../../mapazapp/docs/LIQUIDITY_SWEEP_QUALITY_REFINEMENT_E5_10_2.md), [`LIQUIDITY_CHAIN_REFINEMENT_E5_10_4.md`](../../../mapazapp/docs/LIQUIDITY_CHAIN_REFINEMENT_E5_10_4.md), [`LIQUIDITY_CHAIN_REACTION_AUDIT_E5_10_6.md`](../../../mapazapp/docs/LIQUIDITY_CHAIN_REACTION_AUDIT_E5_10_6.md). |
...
2. Compile in **MetaEditor** (F7) as **`MZP_TestEA_E5_10_6`**.
...
- **Compile** build **`MZP_TestEA_E5_10_6`** (see `TESTEA_BUILD` in `Mapazapp_TestEA.mq5`).
