...
| **E5.20.4** | Dashboard mock UI | **pendiente** — tras E5.20.3.1 |
...
**E5.20.3.1:** evidencia operador **PASS** — [`DASHBOARD_READONLY_ADAPTER_EVIDENCE_E5_20_3_1.md`](./DASHBOARD_READONLY_ADAPTER_EVIDENCE_E5_20_3_1.md). **Siguiente:** **E5.20.4** mock UI read-only.
