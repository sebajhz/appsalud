...
4. Continue roadmap:
   ...
   - ~~**E5.18.2** decision calibration audit.~~ **Done (repo)** — [`SETUP_READINESS_DECISION_CALIBRATION_AUDIT_E5_18_2.md`](./SETUP_READINESS_DECISION_CALIBRATION_AUDIT_E5_18_2.md). **Siguiente:** E5.18.3 evidencia operador.
