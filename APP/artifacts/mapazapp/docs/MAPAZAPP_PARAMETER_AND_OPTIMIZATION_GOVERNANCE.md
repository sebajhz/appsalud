...
4. ~~E5.13.6.12 smoke ST.~~ **Done** — [`BUFFERED_EVOS_SMOKE_EVIDENCE_E5_13_6_12.md`](./BUFFERED_EVOS_SMOKE_EVIDENCE_E5_13_6_12.md). **Next:** E5.13.6.13 entry candidate policy (research-only) or E5.14; **no** edge approval without explicit governance.
