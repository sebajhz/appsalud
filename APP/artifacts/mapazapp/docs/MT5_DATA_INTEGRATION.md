...
**Relacionado:** [`MT5_DETECTION_GATE_AUDIT_D10.md`](./MT5_DETECTION_GATE_AUDIT_D10.md) (**D10.0** auditoría / **D10.1** validador / **D10.3** mapeo runtime conservador), [`MT5_OPEN_ACTION_DESIGN_D10.md`](./MT5_OPEN_ACTION_DESIGN_D10.md) (**D10.2** diseño `open_mt5` sin código), [`MT5_CONFIG_STORAGE_DECISION_D10.md`](./MT5_CONFIG_STORAGE_DECISION_D10.md) (**D10.5** storage/settings sin persistencia real), [`MT5_BRIDGE_FILE_DISCOVERY_AUDIT_D10.md`](./MT5_BRIDGE_FILE_DISCOVERY_AUDIT_D10.md) (**D10.7** discovery read-only documentado), [`END_TO_END_READINESS_AUDIT_D10.md`](./END_TO_END_READINESS_AUDIT_D10.md) (**D10.10** readiness antes de runtime live).
...
**D10.x — Gates / modelo / UI draft (sin runtime live):** [`MT5_DETECTION_GATE_AUDIT_D10.md`](./MT5_DETECTION_GATE_AUDIT_D10.md) (**D10.0**); validador **`mapazapp-mt5-config-model`** (**D10.1**); diseño **`MT5_OPEN_ACTION_DESIGN_D10.md`** (**D10.2**); mapeo runtime **`mapazapp-mt5-runtime-status`** (**D10.3**); panel dashboard read-only mock (**D10.4**); decisión storage **`MT5_CONFIG_STORAGE_DECISION_D10.md`** (**D10.5**); readiness carpeta bridge **`mapazapp-mt5-bridge-readiness`** (**D10.6**); auditoría discovery **`MT5_BRIDGE_FILE_DISCOVERY_AUDIT_D10.md`** (**D10.7**); metadata muestras **`mapazapp-bridge-sample-metadata`** (**D10.8**); copy panel MT5 (**D10.9**); auditoría E2E **`END_TO_END_READINESS_AUDIT_D10.md`** (**D10.10**) — todo **sin** abrir MT5, **sin** watcher, **sin** comandos de trading.
