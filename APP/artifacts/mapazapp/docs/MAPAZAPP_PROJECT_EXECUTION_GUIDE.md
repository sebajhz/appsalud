...
- **Siguiente operativo / investigación:** **E5.13 — Premium/Discount V1** — [`PROFESSIONAL_TRADER_HUMANIZATION_ROADMAP_E5_11.md`](./PROFESSIONAL_TRADER_HUMANIZATION_ROADMAP_E5_11.md) §D (zona de entrada / timing). Cadena liquidez/reacción, HTF y MSS/CHoCH siguen observación-only. Componentes de score: **E5.9.1** §12; reconciliar con audit §15.
