# Mapazapp_TestEA — Official Strategy Tester EA (E3.6–E5.4.1)
...
**Next:** **E5.4.2** — repeat Strategy Tester smoke with **MZP_TestEA_E5_4_1** build after operator refresh (not automated from this repo).
