/**
 * Duplicated from `mapazapp/src/services/mapMockZoneToCore.ts` (checkpoint 11 backend).
 */
import type {
  AccountId,
  ConfirmationResult,
...
export function mockSweepStatusFromZoneState(
  state: ZoneState,
): NonNullable<TradePlanInput["sweep"]>["sweepStatus"] {
...
export function buildZoneCandidateFromMockZone(zone: Zone, spec: SymbolMarketSpec, accountId: AccountId): ZoneCandidate {
