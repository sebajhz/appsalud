...
- **E5.17.1 cerrado (smoke):** [`FREQUENCY_RISK_DISCIPLINE_SMOKE_EVIDENCE_E5_17_1.md`](./FREQUENCY_RISK_DISCIPLINE_SMOKE_EVIDENCE_E5_17_1.md) — `MZP_TestEA_E5_17_0_1`, bundle SET001, PASS; avg score 10.53; max 15. Evidencia válida tras E5.17.1.1.
- **E5.17.1.1 cerrado (repo):** cleanup header CSV duplicado `fvg_ce_price`; build `MZP_TestEA_E5_17_1_1`; validador `DUPLICATE_CSV_HEADER`. **Siguiente:** operador compile + `Import-Csv`; luego **E5.18** checklist.
