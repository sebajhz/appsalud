...
- **E5.20.2.1 evidencia PASS:** [`LATEST_VALID_REPORT_GENERATOR_CLI_EVIDENCE_E5_20_2_1.md`](./LATEST_VALID_REPORT_GENERATOR_CLI_EVIDENCE_E5_20_2_1.md) — SET001, `report_missing` → informe en `_local_E5_20_2_1_*`. **E5.20.2:** [`LATEST_VALID_REPORT_GENERATOR_CLI_E5_20_2.md`](./LATEST_VALID_REPORT_GENERATOR_CLI_E5_20_2.md). **E5.20.5 (docs):** [`HUMANIZED_SETUP_ACCEPTANCE_POLICY_V1_E5_20_5.md`](./HUMANIZED_SETUP_ACCEPTANCE_POLICY_V1_E5_20_5.md) — informes ≠ humanización; aceptación discrecional aparte; **no** abrir E5.20.3 hasta revisión PM. **Siguiente:** E5.20.3 (pausado) o implementación futura de política en exports (gobernanza explícita).
