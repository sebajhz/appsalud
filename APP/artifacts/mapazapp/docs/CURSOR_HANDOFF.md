...
- **E5.21.2 cola JSONL:** [`ALERT_REVIEW_QUEUE_MANAGER_E5_21_2.md`](./ALERT_REVIEW_QUEUE_MANAGER_E5_21_2.md) — estados new/reviewed/dismissed/archived, CLI `mapazapp:alert-review-queue`. **E5.21.1.1 PASS:** [`ALERT_ONLY_REVIEW_FORMATTER_EVIDENCE_E5_21_1_1.md`](./ALERT_ONLY_REVIEW_FORMATTER_EVIDENCE_E5_21_1_1.md). **Siguiente:** E5.21.2.1 evidencia operador cola SET001.
