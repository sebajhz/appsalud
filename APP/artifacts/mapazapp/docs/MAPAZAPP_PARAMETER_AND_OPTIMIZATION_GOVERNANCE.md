...
3. ~~E5.13.6.11 MQL5 Buffered EVOS diagnostics.~~ **Done** — [`BUFFERED_EVOS_EXPORT_E5_13_6_11.md`](./BUFFERED_EVOS_EXPORT_E5_13_6_11.md). **Next:** operator Strategy Tester evidence; entry-model policy only if buffered evidence supports it.
