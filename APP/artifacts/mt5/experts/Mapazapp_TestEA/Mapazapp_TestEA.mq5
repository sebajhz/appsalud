...
input bool              InpEnableSessionSpreadVolatilityV1 = true;
input int               InpSessionTimezoneOffsetHours = 0;
input int               InpSessionAsianStartHour = 0;
input int               InpSessionAsianEndHour = 7;
input int               InpSessionLondonStartHour = 7;
input int               InpSessionLondonEndHour = 12;
input int               InpSessionNewYorkStartHour = 12;
input int               InpSessionNewYorkEndHour = 17;
input int               InpSessionOverlapStartHour = 12;
input int               InpSessionOverlapEndHour = 16;

input bool              InpEnableSpreadContextV1 = true;
input int               InpSpreadWarningPoints = 30;
input int               InpSpreadHighPoints = 50;
input int               InpSpreadExtremePoints = 80;

input bool              InpEnableVolatilityContextV1 = true;
input int               InpVolatilityAtrPeriod = 14;
input int               InpVolatilityLowAtrPoints = 80;
input int               InpVolatilityHighAtrPoints = 250;
...
input bool              InpEnableSetupReadinessChecklistV1 = true;
input bool              InpSetupReadinessScoreEnabled = true;
input int               InpSetupReadinessMinCandidateScore = 70;
input int               InpSetupReadinessMinWaitScore = 45;

#define TESTEA_BUILD            "MZP_TestEA_E5_18"
...
double          g_ssv_sum_exec_score = 0.0;
double          g_ssv_sum_spread_pts = 0.0;
double          g_ssv_sum_atr_pts = 0.0;
double          g_ssv_sum_range_pts = 0.0;
double          g_ssv_sum_range_atr_ratio = 0.0;
long            g_ssv_range_atr_ratio_samples = 0;
long            g_ssv_session_asian_count = 0;
long            g_ssv_session_london_count = 0;
long            g_ssv_session_new_york_count = 0;
long            g_ssv_session_overlap_count = 0;
long            g_ssv_session_off_count = 0;
long            g_ssv_session_unknown_count = 0;
long            g_ssv_spread_normal_count = 0;
long            g_ssv_spread_warning_count = 0;
long            g_ssv_spread_high_count = 0;
long            g_ssv_spread_extreme_count = 0;
long            g_ssv_spread_unknown_count = 0;
long            g_ssv_vol_low_count = 0;
long            g_ssv_vol_normal_count = 0;
long            g_ssv_vol_high_count = 0;
long            g_ssv_vol_extreme_count = 0;
long            g_ssv_vol_unknown_count = 0;
long            g_ssv_env_grade_a = 0;
long            g_ssv_env_grade_b = 0;
...
double          g_ready_sum_score = 0.0;
long            g_ready_sum_blockers = 0;
long            g_ready_sum_warnings = 0;
long            g_ready_candidate_count = 0;
long            g_ready_wait_count = 0;
long            g_ready_reject_count = 0;
long            g_ready_unknown_count = 0;
long            g_ready_grade_a = 0;
long            g_ready_grade_b = 0;
long            g_ready_grade_c = 0;
long            g_ready_grade_weak = 0;
long            g_ready_grade_none = 0;
long            g_ready_bias_block_count = 0;
long            g_ready_liquidity_missing_count = 0;
long            g_ready_ifvg_weak_count = 0;
long            g_ready_ifvg_conflict_count = 0;
long            g_ready_mss_choch_late_count = 0;
long            g_ready_pd_conflict_count = 0;
long            g_ready_entry_fragile_count = 0;
long            g_ready_target_missing_count = 0;
long            g_ready_target_before_liquidity_count = 0;
long            g_ready_environment_weak_count = 0;
long            g_ready_overtrading_warning_count = 0;
...
struct MapzSessionSpreadVolatilitySnap
  {
   bool              log_enabled;
   bool              finalized;
   ...
   int               session_hour;
   int               session_timezone_offset_hours;
   bool              is_asian_session;
   bool              is_london_session;
   bool              is_new_york_session;
   bool              is_london_new_york_overlap;
   bool              is_off_session;
   bool              spread_context_enabled;
   long              spread_points;
   string            spread_bucket;
   bool              spread_is_warning;
   bool              spread_is_high;
   bool              spread_is_extreme;
   bool              volatility_context_enabled;
   double            volatility_atr_points;
   string            volatility_bucket;
   bool              volatility_is_low;
   bool              volatility_is_high;
   bool              volatility_is_extreme;
   double            volatility_range_points;
   double            volatility_range_to_atr_ratio;
   int               execution_environment_score;
   string            execution_environment_grade;
...
struct MapzSetupReadinessSnap
  {
   bool              log_enabled;
   bool              finalized;
   bool              bias_aligned;
   bool              structure_ok;
   bool              liquidity_event_ok;
   bool              ifvg_quality_ok;
   string            ifvg_grade;
   bool              mss_choch_ok;
   bool              mss_choch_timing_ok;
   bool              premium_discount_ok;
   bool              pd_zone_valid;
   bool              entry_feasible;
   string            entry_candidate_family;
   bool              entry_fragility_warning;
   bool              target_ok;
   string            target_grade;
   string            target_type;
   bool              execution_environment_ok;
   string            execution_environment_grade;
   bool              discipline_ok;
   string            discipline_grade;
   bool              overtrading_warning;
   int               score;
   string            grade;
   string            decision;
   int               blocker_count;
...
//+------------------------------------------------------------------+
//| E5.16 — Session / Spread / Volatility context (diagnostic export) |
//+------------------------------------------------------------------+
void MapzSsvSnapClear(MapzSessionSpreadVolatilitySnap &o)
  {
   o.log_enabled = false;
   o.finalized = false;
   o.session_bucket = "unknown";
   o.session_phase = "unknown";
   o.session_hour = -1;
   o.session_timezone_offset_hours = 0;
   o.is_asian_session = false;
   o.is_london_session = false;
   o.is_new_york_session = false;
   o.is_london_new_york_overlap = false;
   o.is_off_session = false;
   o.spread_context_enabled = false;
   o.spread_points = -1;
   o.spread_bucket = "unknown";
   o.spread_is_warning = false;
   o.spread_is_high = false;
   o.spread_is_extreme = false;
   o.volatility_context_enabled = false;
   o.volatility_atr_points = -1.0;
   o.volatility_bucket = "unknown";
   o.volatility_is_low = false;
   o.volatility_is_high = false;
   o.volatility_is_extreme = false;
   o.volatility_range_points = -1.0;
   o.volatility_range_to_atr_ratio = -1.0;
   o.execution_environment_score = 0;
   o.execution_environment_grade = "None";
   o.execution_environment_reasons = "";
  }

//+------------------------------------------------------------------+
bool MapzSsvHourInRange(const int hour, const int startH, const int endH)
  {
   if(startH == endH)
      return false;
   if(startH < endH)
...
//+------------------------------------------------------------------+
int MapzSsvAdjHour(const datetime t)
  {
   MqlDateTime dt;
   TimeToStruct(t, dt);
   int h = dt.hour + InpSessionTimezoneOffsetHours;
   while(h < 0)
      h += 24;
   while(h >= 24)
      h -= 24;
...
//+------------------------------------------------------------------+
string MapzSsvGradeFromScore(const int sc)
  {
   if(sc >= 12)
      return "A";
   if(sc >= 9)
...
//+------------------------------------------------------------------+
string MapzSsvCompactSuffix(const MapzSessionSpreadVolatilitySnap &x)
  {
   return StringFormat("sess=%s spr=%s vol=%s env_score=%d",
                       JsonStringEscape(x.session_bucket),
                       JsonStringEscape(x.spread_bucket),
                       JsonStringEscape(x.volatility_bucket),
                       x.execution_environment_score);
  }

//+------------------------------------------------------------------+
void MapzSsvClassifySession(const int hour, MapzSessionSpreadVolatilitySnap &out)
  {
   out.session_hour = hour;
   out.session_timezone_offset_hours = InpSessionTimezoneOffsetHours;
   out.is_asian_session = MapzSsvHourInRange(hour, InpSessionAsianStartHour, InpSessionAsianEndHour);
   out.is_london_session = MapzSsvHourInRange(hour, InpSessionLondonStartHour, InpSessionLondonEndHour);
   out.is_new_york_session = MapzSsvHourInRange(hour, InpSessionNewYorkStartHour, InpSessionNewYorkEndHour);
   out.is_london_new_york_overlap = MapzSsvHourInRange(hour, InpSessionOverlapStartHour, InpSessionOverlapEndHour);
   out.is_off_session = false;
   if(out.is_london_new_york_overlap)
     {
      out.session_bucket = "london_new_york_overlap";
      MapzEffAppendReasonOnce(out.execution_environment_reasons, "session_overlap");
     }
   else if(out.is_london_session)
     {
      out.session_bucket = "london";
      MapzEffAppendReasonOnce(out.execution_environment_reasons, "session_london");
     }
   else if(out.is_new_york_session)
     {
      out.session_bucket = "new_york";
      MapzEffAppendReasonOnce(out.execution_environment_reasons, "session_new_york");
     }
   else if(out.is_asian_session)
     {
      out.session_bucket = "asian";
      MapzEffAppendReasonOnce(out.execution_environment_reasons, "session_asian");
     }
   else
     {
      out.session_bucket = "off_session";
      out.is_off_session = true;
      MapzEffAppendReasonOnce(out.execution_environment_reasons, "session_off");
     }
   int sessStart = -1;
   int sessEnd = -1;
   if(out.session_bucket == "london_new_york_overlap")
     {
      sessStart = InpSessionOverlapStartHour;
      sessEnd = InpSessionOverlapEndHour;
     }
   else if(out.session_bucket == "london")
     {
      sessStart = InpSessionLondonStartHour;
      sessEnd = InpSessionLondonEndHour;
     }
   else if(out.session_bucket == "new_york")
     {
      sessStart = InpSessionNewYorkStartHour;
      sessEnd = InpSessionNewYorkEndHour;
     }
   else if(out.session_bucket == "asian")
     {
      sessStart = InpSessionAsianStartHour;
      sessEnd = InpSessionAsianEndHour;
     }
   if(sessStart >= 0 && sessEnd >= 0)
     {
      if(hour == sessStart)
         out.session_phase = "session_open_window";
      else if(sessEnd > 0 && hour == (sessEnd - 1 + 24) % 24)
         out.session_phase = "session_close_window";
      else
         out.session_phase = "session_mid_window";
     }
   else
...
//+------------------------------------------------------------------+
void MapzSsvBuildTradeSnap(const string sym,
                           const ENUM_TIMEFRAMES tf,
                           const datetime refTime,
                           MapzSessionSpreadVolatilitySnap &out)
  {
   MapzSsvSnapClear(out);
   out.log_enabled = InpEnableSessionSpreadVolatilityV1;
   if(!InpEnableSessionSpreadVolatilityV1)
     {
      MapzEffAppendReasonOnce(out.execution_environment_reasons, "session_spread_volatility_disabled");
      return;
     }
   if(refTime <= 0)
     {
      ...
      out.session_phase = "unknown";
      MapzEffAppendReasonOnce(out.execution_environment_reasons, "session_unknown");
      return;
     }
   const int hour = MapzSsvAdjHour(refTime);
   MapzSsvClassifySession(hour, out);
   out.spread_context_enabled = InpEnableSpreadContextV1;
   if(InpEnableSpreadContextV1)
     {
      long spr = (long)SymbolInfoInteger(sym, SYMBOL_SPREAD);
      if(spr < 0)
         spr = 0;
      out.spread_points = spr;
      if(spr >= InpSpreadExtremePoints)
        {
         out.spread_bucket = "extreme";
         out.spread_is_extreme = true;
         MapzEffAppendReasonOnce(out.execution_environment_reasons, "spread_extreme");
        }
      else if(spr >= InpSpreadHighPoints)
        {
         out.spread_bucket = "high";
         out.spread_is_high = true;
         MapzEffAppendReasonOnce(out.execution_environment_reasons, "spread_high");
        }
      else if(spr >= InpSpreadWarningPoints)
        {
         out.spread_bucket = "warning";
         out.spread_is_warning = true;
         MapzEffAppendReasonOnce(out.execution_environment_reasons, "spread_warning");
        }
      else
        {
         out.spread_bucket = "normal";
         MapzEffAppendReasonOnce(out.execution_environment_reasons, "spread_normal");
        }
     }
   else
     {
      out.spread_bucket = "unknown";
      MapzEffAppendReasonOnce(out.execution_environment_reasons, "spread_unknown");
     }
   out.volatility_context_enabled = InpEnableVolatilityContextV1;
   if(InpEnableVolatilityContextV1)
     {
      const double pt = SymbolInfoDouble(sym, SYMBOL_POINT);
      const int atrPeriod = (InpVolatilityAtrPeriod > 1 ? InpVolatilityAtrPeriod : 14);
      const int atrHandle = iATR(sym, tf, atrPeriod);
      double atrVal = 0.0;
      ...
      if(atrVal > 0.0 && pt > 0.0)
        {
         out.volatility_atr_points = atrVal / pt;
         const double hi = iHigh(sym, tf, 1);
         const double lo = iLow(sym, tf, 1);
         if(hi > 0.0 && lo > 0.0 && hi >= lo)
           {
            out.volatility_range_points = (hi - lo) / pt;
            out.volatility_range_to_atr_ratio = out.volatility_range_points / out.volatility_atr_points;
           }
         const double atrPts = out.volatility_atr_points;
         if(atrPts < (double)InpVolatilityLowAtrPoints)
           {
            out.volatility_bucket = "low";
            out.volatility_is_low = true;
            MapzEffAppendReasonOnce(out.execution_environment_reasons, "volatility_low");
           }
         else if(atrPts >= (double)InpVolatilityExtremeAtrPoints)
           {
            out.volatility_bucket = "extreme";
            out.volatility_is_extreme = true;
            MapzEffAppendReasonOnce(out.execution_environment_reasons, "volatility_extreme");
           }
         else if(atrPts >= (double)InpVolatilityHighAtrPoints)
           {
            out.volatility_bucket = "high";
            out.volatility_is_high = true;
            MapzEffAppendReasonOnce(out.execution_environment_reasons, "volatility_high");
           }
         else
           {
            out.volatility_bucket = "normal";
            MapzEffAppendReasonOnce(out.execution_environment_reasons, "volatility_normal");
           }
         if(out.volatility_range_to_atr_ratio >= 0.0)
           {
            if(out.volatility_range_to_atr_ratio >= 0.35 && out.volatility_range_to_atr_ratio <= 2.5)
               MapzEffAppendReasonOnce(out.execution_environment_reasons, "range_atr_normal");
            else
               MapzEffAppendReasonOnce(out.execution_environment_reasons, "range_atr_abnormal");
           }
        }
      else
        {
         out.volatility_bucket = "unknown";
         MapzEffAppendReasonOnce(out.execution_environment_reasons, "volatility_unknown");
        }
     }
   else
     {
   ...
   if(!InpVolatilityScoreEnabled)
      return;
   int sc = 0;
   if(out.session_bucket == "london_new_york_overlap")
      sc += 4;
   else if(out.session_bucket == "london" || out.session_bucket == "new_york")
      sc += 3;
   else if(out.session_bucket == "asian")
      sc += 1;
   else if(out.session_bucket == "off_session")
      sc -= 2;
   else
      sc -= 1;
   if(out.spread_bucket == "normal")
      sc += 3;
   else if(out.spread_bucket == "warning")
      sc += 1;
   else if(out.spread_bucket == "high")
      sc -= 2;
   else if(out.spread_bucket == "extreme")
      sc -= 4;
   else
      sc -= 1;
   if(out.volatility_bucket == "normal")
      sc += 3;
   else if(out.volatility_bucket == "high")
      sc += 2;
   else if(out.volatility_bucket == "low")
      sc -= 2;
   else if(out.volatility_bucket == "extreme")
      sc -= 3;
   else
      sc -= 1;
   if(out.volatility_range_to_atr_ratio >= 0.35 && out.volatility_range_to_atr_ratio <= 2.5)
      sc += 2;
   else if(out.volatility_range_to_atr_ratio >= 0.0)
      sc -= 2;
   if(sc < 0)
      sc = 0;
   if(sc > 15)
      sc = 15;
   out.execution_environment_score = sc;
   out.execution_environment_grade = MapzSsvGradeFromScore(sc);
   if(out.execution_environment_grade == "A")
      MapzEffAppendReasonOnce(out.execution_environment_reasons, "execution_env_score_a");
   else if(out.execution_environment_grade == "B")
      MapzEffAppendReasonOnce(out.execution_environment_reasons, "execution_env_score_b");
   else if(out.execution_environment_grade == "C")
      MapzEffAppendReasonOnce(out.execution_environment_reasons, "execution_env_score_c");
   else if(out.execution_environment_grade == "Weak")
      MapzEffAppendReasonOnce(out.execution_environment_reasons, "execution_env_score_weak");
  }

//+------------------------------------------------------------------+
void MapzSsvFinalize(MapzSessionSpreadVolatilitySnap &out)
  {
   if(!out.log_enabled || out.finalized)
      return;
   out.finalized = true;
   if(out.session_bucket == "asian")
      g_ssv_session_asian_count++;
   else if(out.session_bucket == "london")
      g_ssv_session_london_count++;
   else if(out.session_bucket == "new_york")
      g_ssv_session_new_york_count++;
   else if(out.session_bucket == "london_new_york_overlap")
      g_ssv_session_overlap_count++;
   else if(out.session_bucket == "off_session")
      g_ssv_session_off_count++;
   else
      g_ssv_session_unknown_count++;
   if(out.spread_bucket == "normal")
      g_ssv_spread_normal_count++;
   else if(out.spread_bucket == "warning")
      g_ssv_spread_warning_count++;
   else if(out.spread_bucket == "high")
      g_ssv_spread_high_count++;
   else if(out.spread_bucket == "extreme")
      g_ssv_spread_extreme_count++;
   else
      g_ssv_spread_unknown_count++;
   if(out.volatility_bucket == "low")
      g_ssv_vol_low_count++;
   else if(out.volatility_bucket == "normal")
      g_ssv_vol_normal_count++;
   else if(out.volatility_bucket == "high")
      g_ssv_vol_high_count++;
   else if(out.volatility_bucket == "extreme")
      g_ssv_vol_extreme_count++;
   else
      g_ssv_vol_unknown_count++;
   if(out.execution_environment_grade == "A")
      g_ssv_env_grade_a++;
   else if(out.execution_environment_grade == "B")
      g_ssv_env_grade_b++;
...
//+------------------------------------------------------------------+
void MapzReadySnapClear(MapzSetupReadinessSnap &o)
  {
   o.log_enabled = false;
   o.finalized = false;
   o.bias_aligned = false;
   o.structure_ok = false;
   o.liquidity_event_ok = false;
   o.ifvg_quality_ok = false;
   o.ifvg_grade = "None";
   o.mss_choch_ok = false;
   o.mss_choch_timing_ok = false;
   o.premium_discount_ok = false;
   o.pd_zone_valid = false;
   o.entry_feasible = false;
   o.entry_candidate_family = "unknown";
   o.entry_fragility_warning = false;
   o.target_ok = false;
   o.target_grade = "None";
   o.target_type = "unknown";
   o.execution_environment_ok = false;
   o.execution_environment_grade = "None";
   o.discipline_ok = false;
   o.discipline_grade = "None";
   o.overtrading_warning = false;
   o.score = 0;
   o.grade = "None";
   o.decision = "unknown";
   o.blocker_count = 0;
...
//+------------------------------------------------------------------+
int MapzReadyClampScore(const int sc)
  {
   if(sc < 0)
      return 0;
   if(sc > 100)
...
//+------------------------------------------------------------------+
string MapzReadyGradeFromScore(const int sc)
  {
   const int bounded = MapzReadyClampScore(sc);
   if(bounded >= 85)
      return "A";
   if(bounded >= 70)
      return "B";
...
//+------------------------------------------------------------------+
bool MapzReadyGradeIsWeakOrWorse(const string grade)
  {
   return (grade == "Weak" || grade == "None" || grade == "");
  }

//+------------------------------------------------------------------+
void MapzReadyResolveTargetType(const MapzLiquidityTargetQualitySnap &lq,
                                string &outType)
  {
   outType = "unknown";
   if(!lq.log_enabled)
      return;
   if(lq.nearest_distance_points < 0 || StringFind(lq.reasons, "liquidity_target_missing") >= 0)
     {
      outType = "missing";
      return;
     }
   if(lq.reached_by_official_tp)
      outType = "liquidity_aligned";
   else if(lq.tp_beyond_nearest_liquidity)
      outType = "extended_liquidity";
   else if(lq.tp_before_nearest_liquidity)
      outType = "conservative_rr";
   else if(lq.supported)
      outType = "liquidity_aligned";
   else
      outType = "unknown";
  }
...
//+------------------------------------------------------------------+
string MapzReadyResolveEntryFamily(const bool filled,
                                   const MapzEntryVariantFeasibilitySnap &ev)
  {
   if(filled)
      return "official_50_ce";
   if(!ev.log_enabled)
      return "wait";
   if(ev.edge_reached && !ev.p50_reached)
      return "edge_research";
   if(ev.p25_reached && !ev.p50_reached)
      return "p25_research";
   if(ev.adaptive_reached && !ev.p50_reached)
      return "adaptive_research";
   return "wait";
  }

//+------------------------------------------------------------------+
void MapzReadyBuildAndScore(const ENUM_MAPZ_SETUP_DIR tradeDir,
                            const ENUM_MAPZ_BIAS biasEnum,
                            const bool filled,
                            const MapzLiquiditySnapshot &liq,
                            const MapzHtfTradeSnap &htf,
                            const MapzMssChochTradeSnap &msc,
                            const MapzPremiumDiscountTradeSnap &pd,
                            const MapzIfvgBisiSibiTradeSnap &ifvg,
                            const MapzLiquidityTargetQualitySnap &lqTgt,
                            const MapzSessionSpreadVolatilitySnap &ssv,
                            const MapzFrequencyRiskDisciplineSnap &disc,
                            const MapzEntryFillFeasibilitySnap &eff,
                            const MapzEntryVariantFeasibilitySnap &ev,
                            MapzSetupReadinessSnap &out)
  {
   MapzReadySnapClear(out);
   out.log_enabled = InpEnableSetupReadinessChecklistV1;
   if(!out.log_enabled)
     {
      MapzEffAppendReasonOnce(out.reasons, "checklist_disabled");
      out.decision = "unknown";
      return;
     }

   const bool isLong = (tradeDir == MAPZ_SETUP_LONG);
   out.bias_aligned = (!InpRequireDailyBiasAlignment)
                      || (isLong && biasEnum == MAPZ_BIAS_BULLISH)
                      || (!isLong && biasEnum == MAPZ_BIAS_BEARISH);
   if(out.bias_aligned)
      MapzEffAppendReasonOnce(out.reasons, "checklist_bias_ok");
   else
     {
      MapzEffAppendReasonOnce(out.reasons, "checklist_bias_block");
      out.primary_blocker = "bias_not_aligned";
     }

   if(!htf.enabled)
      out.structure_ok = true;
   else
      out.structure_ok = (htf.htf_structure_aligned && !htf.htf_structure_conflict)
                         || htf.htf_structure_score >= 6;
   if(!htf.enabled || out.structure_ok)
     { /* structure ok or not evaluated */ }
   else if(out.primary_blocker == "")
      out.primary_blocker = "structure_conflict";

   if(!InpEnableLiquiditySweepDetection)
      out.liquidity_event_ok = true;
   else
      out.liquidity_event_ok = (liq.detected
                                && liq.quality_grade != "None"
                                && liq.quality_grade != "Weak");
   if(out.liquidity_event_ok)
      MapzEffAppendReasonOnce(out.reasons, "checklist_liquidity_ok");
   else
     {
      MapzEffAppendReasonOnce(out.reasons, "checklist_liquidity_missing");
      if(out.primary_blocker == "")
         out.primary_blocker = "liquidity_missing";
     }

   out.ifvg_grade = (ifvg.log_enabled ? ifvg.grade : "None");
   if(!ifvg.log_enabled)
      out.ifvg_quality_ok = true;
   else if(ifvg.ifvg_conflict_with_trade_direction)
     {
      out.ifvg_quality_ok = false;
      MapzEffAppendReasonOnce(out.reasons, "checklist_ifvg_conflict");
      if(out.primary_blocker == "")
         out.primary_blocker = "ifvg_conflict";
     }
   else if(ifvg.grade == "A" || ifvg.grade == "B" || ifvg.grade == "C")
     {
      out.ifvg_quality_ok = true;
      MapzEffAppendReasonOnce(out.reasons, "checklist_ifvg_ok");
     }
   else
     {
      out.ifvg_quality_ok = false;
      MapzEffAppendReasonOnce(out.reasons, "checklist_ifvg_weak");
     }

   if(!msc.enabled)
     {
      out.mss_choch_ok = true;
      out.mss_choch_timing_ok = true;
     }
   else
     {
      out.mss_choch_ok = ((msc.mss_detected && msc.mss_valid_close)
                          || (msc.choch_detected && msc.choch_valid_close));
      out.mss_choch_timing_ok = (!msc.mss_too_late && !msc.choch_too_late);
      if(out.mss_choch_ok && out.mss_choch_timing_ok)
         MapzEffAppendReasonOnce(out.reasons, "checklist_mss_choch_ok");
      else if(!out.mss_choch_timing_ok)
        {
         MapzEffAppendReasonOnce(out.reasons, "checklist_mss_choch_late");
         if(out.primary_blocker == "")
            out.primary_blocker = "mss_choch_late";
        }
     }

   if(!pd.log_enabled)
     {
      out.premium_discount_ok = true;
      out.pd_zone_valid = true;
     }
   else
     {
      out.pd_zone_valid = pd.zone_valid_for_direction && !pd.zone_conflict;
      out.premium_discount_ok = (pd.score >= 6 && !MapzReadyGradeIsWeakOrWorse(pd.grade));
      if(pd.zone_conflict)
        {
         MapzEffAppendReasonOnce(out.reasons, "checklist_pd_conflict");
         if(out.primary_blocker == "")
            out.primary_blocker = "pd_conflict";
        }
      else if(out.premium_discount_ok && out.pd_zone_valid)
         MapzEffAppendReasonOnce(out.reasons, "checklist_pd_ok");
     }

   out.entry_candidate_family = MapzReadyResolveEntryFamily(filled, ev);
   if(!eff.log_enabled)
      out.entry_feasible = filled;
   else
      out.entry_feasible = (eff.fill_status == "filled")
                           || (eff.score >= 6 && filled);
   out.entry_fragility_warning = (eff.entry_near_miss
                                  || eff.entry_filled_late
                                  || eff.entry_too_deep_for_retest
                                  || eff.entry_missed_shallow_retrace);
   if(out.entry_feasible && !out.entry_fragility_warning)
      MapzEffAppendReasonOnce(out.reasons, "checklist_entry_feasible");
   else if(out.entry_fragility_warning)
     {
      MapzEffAppendReasonOnce(out.reasons, "checklist_entry_fragile");
      if(out.primary_blocker == "")
         out.primary_blocker = "entry_fragile";
     }

   out.target_grade = (lqTgt.log_enabled ? lqTgt.grade : "None");
   MapzReadyResolveTargetType(lqTgt, out.target_type);
   if(!lqTgt.log_enabled)
      out.target_ok = true;
   else
      out.target_ok = (lqTgt.supported
                       && !lqTgt.conflict
                       && lqTgt.nearest_distance_points >= 0
                       && out.target_type != "missing");
   if(out.target_ok)
      MapzEffAppendReasonOnce(out.reasons, "checklist_target_ok");
   else if(out.target_type == "missing")
     {
      MapzEffAppendReasonOnce(out.reasons, "checklist_target_missing");
      if(out.primary_blocker == "")
         out.primary_blocker = "target_missing";
     }
   else if(lqTgt.tp_before_nearest_liquidity)
      MapzEffAppendReasonOnce(out.reasons, "checklist_target_before_liquidity");

   out.execution_environment_grade = (ssv.log_enabled ? ssv.execution_environment_grade : "None");
   if(!ssv.log_enabled)
      out.execution_environment_ok = true;
   else
      out.execution_environment_ok = (ssv.execution_environment_grade == "A"
                                      || ssv.execution_environment_grade == "B"
                                      || ssv.execution_environment_grade == "C");
   if(out.execution_environment_ok)
      MapzEffAppendReasonOnce(out.reasons, "checklist_environment_ok");
   else
     {
      MapzEffAppendReasonOnce(out.reasons, "checklist_environment_weak");
      if(out.primary_blocker == "")
         out.primary_blocker = "execution_environment_weak";
     }

   out.discipline_grade = (disc.log_enabled ? disc.grade : "None");
   if(!disc.log_enabled)
      out.discipline_ok = true;
   else
      out.discipline_ok = (disc.grade == "A" || disc.grade == "B" || disc.grade == "C");
   out.overtrading_warning = (disc.log_enabled && disc.overtrading_risk);
   if(disc.daily_loss_limit_reached && disc.log_enabled)
     {
      if(out.primary_blocker == "")
         out.primary_blocker = "daily_loss_limit_warning";
     }
   if(out.discipline_ok && !out.overtrading_warning)
      MapzEffAppendReasonOnce(out.reasons, "checklist_discipline_ok");
   else if(out.overtrading_warning)
      MapzEffAppendReasonOnce(out.reasons, "checklist_overtrading_warning");
   ...
   if(out.ifvg_quality_ok)
      sc += 10;
   else if(ifvg.log_enabled && ifvg.ifvg_conflict_with_trade_direction)
      blockers++;
   else
     {
      warnings++;
   ...
   if(out.premium_discount_ok && out.pd_zone_valid)
      sc += 10;
   else if(pd.log_enabled && pd.zone_conflict)
      blockers++;
   else
      warnings++;

   if(out.entry_feasible)
      sc += 10;
   else
      blockers++;
   if(out.entry_fragility_warning)
      warnings++;
   ...
   if(out.discipline_ok)
      sc += 10;
   else
      warnings++;
   if(out.overtrading_warning)
      warnings++;

   sc = MapzReadyClampScore(sc);
   out.blocker_count = blockers;
   out.warning_count = warnings;
   out.score = sc;
   out.grade = MapzReadyGradeFromScore(sc);

   if(!InpSetupReadinessScoreEnabled)
     {
      out.decision = "unknown";
      out.grade = "None";
      return;
   ...
   if(blockers > 0)
      out.decision = "reject";
   else if(sc >= InpSetupReadinessMinCandidateScore)
      out.decision = "candidate";
   else if(sc >= InpSetupReadinessMinWaitScore)
      out.decision = "wait";
   else
      out.decision = "reject";

   if(out.decision == "candidate")
      MapzEffAppendReasonOnce(out.reasons, "checklist_candidate");
   else if(out.decision == "wait")
      MapzEffAppendReasonOnce(out.reasons, "checklist_wait");
   else if(out.decision == "reject")
      MapzEffAppendReasonOnce(out.reasons, "checklist_reject");
  }

//+------------------------------------------------------------------+
void MapzReadyFinalizeSummary(MapzSetupReadinessSnap &out)
  {
   if(!out.log_enabled || out.finalized)
      return;
   out.finalized = true;
   ...
   if(!out.bias_aligned)
      g_ready_bias_block_count++;
   if(!out.liquidity_event_ok)
      g_ready_liquidity_missing_count++;
   if(out.ifvg_grade == "Weak" || out.ifvg_grade == "None")
      g_ready_ifvg_weak_count++;
   if(StringFind(out.reasons, "checklist_ifvg_conflict") >= 0)
      g_ready_ifvg_conflict_count++;
   if(StringFind(out.reasons, "checklist_mss_choch_late") >= 0)
      g_ready_mss_choch_late_count++;
   if(StringFind(out.reasons, "checklist_pd_conflict") >= 0)
      g_ready_pd_conflict_count++;
   if(out.entry_fragility_warning)
      g_ready_entry_fragile_count++;
   if(out.target_type == "missing")
      g_ready_target_missing_count++;
   if(StringFind(out.reasons, "checklist_target_before_liquidity") >= 0)
      g_ready_target_before_liquidity_count++;
   if(!out.execution_environment_ok)
      g_ready_environment_weak_count++;
   if(out.overtrading_warning)
      g_ready_overtrading_warning_count++;

   g_ready_sum_score += (double)out.score;
   g_ready_sum_blockers += (long)out.blocker_count;
   g_ready_sum_warnings += (long)out.warning_count;

   if(out.decision == "candidate")
      g_ready_candidate_count++;
   else if(out.decision == "wait")
      g_ready_wait_count++;
   else if(out.decision == "reject")
      g_ready_reject_count++;
   else
      g_ready_unknown_count++;
...
//+------------------------------------------------------------------+
string MapzReadyCompactSuffix(const MapzSetupReadinessSnap &x)
  {
   if(!x.log_enabled)
      return "ready=off";
   return StringFormat("ready_score=%d ready_decision=%s ready_blocker=%s",
                       x.score,
                       JsonStringEscape(x.decision),
                       JsonStringEscape(x.primary_blocker));
  }
...
string VirtualBuildDetailsCore(void)
  {
   ...
   return base + " " + MapzEqScoresToDetailsSuffix(eqp, g_vt.liq, g_vt.htf) + " " + MapzMscCompactSuffix(g_vt.msc) + " " + MapzPdCompactSuffix(g_vt.pd) + " " + MapzIfvgCompactSuffix(g_vt.ifvg) + " " + MapzLqTgtCompactSuffix(g_vt.lqTgt) + " " + MapzSsvCompactSuffix(g_vt.ssv) + " " + MapzDiscCompactSuffix(g_vt.disc) + " " + MapzReadyCompactSuffix(g_vt.ready) + " " + MapzEffCompactSuffix(g_vt.eff);
  }
...
void VirtualAppendTradeCsvRow(const int bars_to_fill_export,
                               ...
                               const string rejection_csv)
  {
   ...
   if(InpEnableSessionSpreadVolatilityV1)
     {
      const datetime ssvRef = (g_vt.entry_time > 0 ? g_vt.entry_time : g_vt.setup_time);
      MapzSsvBuildTradeSnap(g_brokerSymbol, InpExecutionTimeframe, ssvRef, g_vt.ssv);
     }
   ...
   MapzReadyBuildAndScore(g_vt.dir,
                          g_vt.bias_enum,
                          g_vt.filled,
                          g_vt.liq,
                          g_vt.htf,
                          ...
                          g_vt.ev,
                          g_vt.ready);
   MapzReadyFinalizeSummary(g_vt.ready);
   ...
   row += "," + IntegerToString(eqp.entry_quality_score)
          ...
          + "," + g_vt.lqTgt.grade
          + "," + g_vt.lqTgt.reasons
          + "," + (g_vt.ssv.log_enabled ? "true" : "false")
          + "," + g_vt.ssv.session_bucket
          + "," + g_vt.ssv.session_phase
          + "," + IntegerToString(g_vt.ssv.session_hour)
          + "," + IntegerToString(g_vt.ssv.session_timezone_offset_hours)
          + "," + (g_vt.ssv.is_asian_session ? "true" : "false")
          + "," + (g_vt.ssv.is_london_session ? "true" : "false")
          + "," + (g_vt.ssv.is_new_york_session ? "true" : "false")
          + "," + (g_vt.ssv.is_london_new_york_overlap ? "true" : "false")
          + "," + (g_vt.ssv.is_off_session ? "true" : "false")
          + "," + (g_vt.ssv.spread_context_enabled ? "true" : "false")
          + "," + IntegerToString((int)g_vt.ssv.spread_points)
          + "," + g_vt.ssv.spread_bucket
          + "," + (g_vt.ssv.spread_is_warning ? "true" : "false")
          + "," + (g_vt.ssv.spread_is_high ? "true" : "false")
          + "," + (g_vt.ssv.spread_is_extreme ? "true" : "false")
          + "," + (g_vt.ssv.volatility_context_enabled ? "true" : "false")
          + "," + DoubleToString(g_vt.ssv.volatility_atr_points, 2)
          + "," + g_vt.ssv.volatility_bucket
          + "," + (g_vt.ssv.volatility_is_low ? "true" : "false")
          + "," + (g_vt.ssv.volatility_is_high ? "true" : "false")
          + "," + (g_vt.ssv.volatility_is_extreme ? "true" : "false")
          + "," + DoubleToString(g_vt.ssv.volatility_range_points, 2)
          + "," + DoubleToString(g_vt.ssv.volatility_range_to_atr_ratio, 4)
          ...
          + "," + g_vt.disc.grade
          + "," + g_vt.disc.reasons
          + "," + (g_vt.ready.log_enabled ? "true" : "false")
          + "," + (g_vt.ready.bias_aligned ? "true" : "false")
          + "," + (g_vt.ready.structure_ok ? "true" : "false")
          + "," + (g_vt.ready.liquidity_event_ok ? "true" : "false")
          + "," + (g_vt.ready.ifvg_quality_ok ? "true" : "false")
          + "," + g_vt.ready.ifvg_grade
          + "," + (g_vt.ready.mss_choch_ok ? "true" : "false")
          + "," + (g_vt.ready.mss_choch_timing_ok ? "true" : "false")
          + "," + (g_vt.ready.premium_discount_ok ? "true" : "false")
          + "," + (g_vt.ready.pd_zone_valid ? "true" : "false")
          + "," + (g_vt.ready.entry_feasible ? "true" : "false")
          + "," + g_vt.ready.entry_candidate_family
          + "," + (g_vt.ready.entry_fragility_warning ? "true" : "false")
          + "," + (g_vt.ready.target_ok ? "true" : "false")
          + "," + g_vt.ready.target_grade
          + "," + g_vt.ready.target_type
          + "," + (g_vt.ready.execution_environment_ok ? "true" : "false")
          + "," + g_vt.ready.execution_environment_grade
          + "," + (g_vt.ready.discipline_ok ? "true" : "false")
          + "," + g_vt.ready.discipline_grade
          + "," + (g_vt.ready.overtrading_warning ? "true" : "false")
          + "," + IntegerToString(g_vt.ready.score)
          + "," + g_vt.ready.grade
          + "," + g_vt.ready.decision
          + "," + IntegerToString(g_vt.ready.blocker_count)
          + "," + IntegerToString(g_vt.ready.warning_count)
          + "," + g_vt.ready.primary_blocker
          + "," + g_vt.ready.reasons
   ...
   if(InpEnableSessionSpreadVolatilityV1 && g_vt.ssv.log_enabled)
     {
      g_ssv_sum_exec_score += (double)g_vt.ssv.execution_environment_score;
      if(g_vt.ssv.spread_points >= 0)
         g_ssv_sum_spread_pts += (double)g_vt.ssv.spread_points;
      if(g_vt.ssv.volatility_atr_points >= 0.0)
         g_ssv_sum_atr_pts += g_vt.ssv.volatility_atr_points;
      if(g_vt.ssv.volatility_range_points >= 0.0)
         g_ssv_sum_range_pts += g_vt.ssv.volatility_range_points;
      if(g_vt.ssv.volatility_range_to_atr_ratio >= 0.0)
        {
         g_ssv_sum_range_atr_ratio += g_vt.ssv.volatility_range_to_atr_ratio;
         g_ssv_range_atr_ratio_samples++;
        }
     }
...
string WriteSummaryJson(void)
  {
   ...
   json += "  \"has_setup_readiness_checklist_v1_logic\": true,\r\n";
   json += "  \"setup_readiness_checklist_enabled\": " + (InpEnableSetupReadinessChecklistV1 ? "true" : "false") + ",\r\n";
   ...
   const double avgSsvExec = (tcRows > 0 ? g_ssv_sum_exec_score / (double)tcRows : 0.0);
   const double avgSsvSpread = (tcRows > 0 ? g_ssv_sum_spread_pts / (double)tcRows : 0.0);
   const double avgSsvAtr = (tcRows > 0 ? g_ssv_sum_atr_pts / (double)tcRows : 0.0);
   const double avgSsvRange = (tcRows > 0 ? g_ssv_sum_range_pts / (double)tcRows : 0.0);
   const double avgSsvRangeAtr = (g_ssv_range_atr_ratio_samples > 0 ? g_ssv_sum_range_atr_ratio / (double)g_ssv_range_atr_ratio_samples : 0.0);
   json += StringFormat("  \"session_asian_count\": %I64d,\r\n", g_ssv_session_asian_count);
   json += StringFormat("  \"session_london_count\": %I64d,\r\n", g_ssv_session_london_count);
   json += StringFormat("  \"session_new_york_count\": %I64d,\r\n", g_ssv_session_new_york_count);
   json += StringFormat("  \"session_overlap_count\": %I64d,\r\n", g_ssv_session_overlap_count);
   json += StringFormat("  \"session_off_count\": %I64d,\r\n", g_ssv_session_off_count);
   json += StringFormat("  \"session_unknown_count\": %I64d,\r\n", g_ssv_session_unknown_count);
   json += StringFormat("  \"spread_normal_count\": %I64d,\r\n", g_ssv_spread_normal_count);
   json += StringFormat("  \"spread_warning_count\": %I64d,\r\n", g_ssv_spread_warning_count);
   json += StringFormat("  \"spread_high_count\": %I64d,\r\n", g_ssv_spread_high_count);
   json += StringFormat("  \"spread_extreme_count\": %I64d,\r\n", g_ssv_spread_extreme_count);
   json += StringFormat("  \"spread_unknown_count\": %I64d,\r\n", g_ssv_spread_unknown_count);
   json += StringFormat("  \"average_spread_points\": %.6f,\r\n", avgSsvSpread);
   json += StringFormat("  \"volatility_low_count\": %I64d,\r\n", g_ssv_vol_low_count);
   json += StringFormat("  \"volatility_normal_count\": %I64d,\r\n", g_ssv_vol_normal_count);
   json += StringFormat("  \"volatility_high_count\": %I64d,\r\n", g_ssv_vol_high_count);
   json += StringFormat("  \"volatility_extreme_count\": %I64d,\r\n", g_ssv_vol_extreme_count);
   json += StringFormat("  \"volatility_unknown_count\": %I64d,\r\n", g_ssv_vol_unknown_count);
   json += StringFormat("  \"average_volatility_atr_points\": %.6f,\r\n", avgSsvAtr);
   json += StringFormat("  \"average_volatility_range_points\": %.6f,\r\n", avgSsvRange);
   json += StringFormat("  \"average_volatility_range_to_atr_ratio\": %.6f,\r\n", avgSsvRangeAtr);
   json += StringFormat("  \"average_execution_environment_score\": %.6f,\r\n", avgSsvExec);
   json += StringFormat("  \"execution_environment_grade_a_count\": %I64d,\r\n", g_ssv_env_grade_a);
   json += StringFormat("  \"execution_environment_grade_b_count\": %I64d,\r\n", g_ssv_env_grade_b);
   ...
   const double avgReadyScore = (tcRows > 0 ? g_ready_sum_score / (double)tcRows : 0.0);
   const double avgReadyBlockers = (tcRows > 0 ? (double)g_ready_sum_blockers / (double)tcRows : 0.0);
   const double avgReadyWarnings = (tcRows > 0 ? (double)g_ready_sum_warnings / (double)tcRows : 0.0);
   json += StringFormat("  \"setup_readiness_candidate_count\": %I64d,\r\n", g_ready_candidate_count);
   json += StringFormat("  \"setup_readiness_wait_count\": %I64d,\r\n", g_ready_wait_count);
   json += StringFormat("  \"setup_readiness_reject_count\": %I64d,\r\n", g_ready_reject_count);
   json += StringFormat("  \"setup_readiness_unknown_count\": %I64d,\r\n", g_ready_unknown_count);
   json += StringFormat("  \"average_setup_readiness_score\": %.6f,\r\n", avgReadyScore);
   json += StringFormat("  \"setup_readiness_grade_a_count\": %I64d,\r\n", g_ready_grade_a);
   json += StringFormat("  \"setup_readiness_grade_b_count\": %I64d,\r\n", g_ready_grade_b);
   json += StringFormat("  \"setup_readiness_grade_c_count\": %I64d,\r\n", g_ready_grade_c);
   json += StringFormat("  \"setup_readiness_grade_weak_count\": %I64d,\r\n", g_ready_grade_weak);
   json += StringFormat("  \"setup_readiness_grade_none_count\": %I64d,\r\n", g_ready_grade_none);
   json += StringFormat("  \"checklist_bias_block_count\": %I64d,\r\n", g_ready_bias_block_count);
   json += StringFormat("  \"checklist_liquidity_missing_count\": %I64d,\r\n", g_ready_liquidity_missing_count);
   json += StringFormat("  \"checklist_ifvg_weak_count\": %I64d,\r\n", g_ready_ifvg_weak_count);
   json += StringFormat("  \"checklist_ifvg_conflict_count\": %I64d,\r\n", g_ready_ifvg_conflict_count);
   json += StringFormat("  \"checklist_mss_choch_late_count\": %I64d,\r\n", g_ready_mss_choch_late_count);
   json += StringFormat("  \"checklist_pd_conflict_count\": %I64d,\r\n", g_ready_pd_conflict_count);
   json += StringFormat("  \"checklist_entry_fragile_count\": %I64d,\r\n", g_ready_entry_fragile_count);
   json += StringFormat("  \"checklist_target_missing_count\": %I64d,\r\n", g_ready_target_missing_count);
   json += StringFormat("  \"checklist_target_before_liquidity_count\": %I64d,\r\n", g_ready_target_before_liquidity_count);
   json += StringFormat("  \"checklist_environment_weak_count\": %I64d,\r\n", g_ready_environment_weak_count);
   json += StringFormat("  \"checklist_overtrading_warning_count\": %I64d,\r\n", g_ready_overtrading_warning_count);
   json += StringFormat("  \"setup_readiness_average_blocker_count\": %.6f,\r\n", avgReadyBlockers);
   json += StringFormat("  \"setup_readiness_average_warning_count\": %.6f,\r\n", avgReadyWarnings);
   ...
   json += "    \"session_spread_volatility_v1_enabled\": " + (InpEnableSessionSpreadVolatilityV1 ? "true" : "false") + ",\r\n";
   json += StringFormat("    \"session_timezone_offset_hours\": %d,\r\n", InpSessionTimezoneOffsetHours);
   json += StringFormat("    \"session_asian_start_hour\": %d,\r\n", InpSessionAsianStartHour);
   json += StringFormat("    \"session_asian_end_hour\": %d,\r\n", InpSessionAsianEndHour);
   json += StringFormat("    \"session_london_start_hour\": %d,\r\n", InpSessionLondonStartHour);
   json += StringFormat("    \"session_london_end_hour\": %d,\r\n", InpSessionLondonEndHour);
   json += StringFormat("    \"session_new_york_start_hour\": %d,\r\n", InpSessionNewYorkStartHour);
   json += StringFormat("    \"session_new_york_end_hour\": %d,\r\n", InpSessionNewYorkEndHour);
   json += StringFormat("    \"session_overlap_start_hour\": %d,\r\n", InpSessionOverlapStartHour);
   json += StringFormat("    \"session_overlap_end_hour\": %d,\r\n", InpSessionOverlapEndHour);
   json += "    \"spread_context_v1_enabled\": " + (InpEnableSpreadContextV1 ? "true" : "false") + ",\r\n";
   json += StringFormat("    \"spread_warning_points\": %d,\r\n", InpSpreadWarningPoints);
   json += StringFormat("    \"spread_high_points\": %d,\r\n", InpSpreadHighPoints);
   json += StringFormat("    \"spread_extreme_points\": %d,\r\n", InpSpreadExtremePoints);
   json += "    \"volatility_context_v1_enabled\": " + (InpEnableVolatilityContextV1 ? "true" : "false") + ",\r\n";
   json += StringFormat("    \"volatility_atr_period\": %d,\r\n", InpVolatilityAtrPeriod);
   json += StringFormat("    \"volatility_low_atr_points\": %d,\r\n", InpVolatilityLowAtrPoints);
   ...
   json += "    \"setup_readiness_checklist_v1_enabled\": " + (InpEnableSetupReadinessChecklistV1 ? "true" : "false") + ",\r\n";
   json += "    \"setup_readiness_score_enabled\": " + (InpSetupReadinessScoreEnabled ? "true" : "false") + ",\r\n";
   json += StringFormat("    \"setup_readiness_min_candidate_score\": %d,\r\n", InpSetupReadinessMinCandidateScore);
   json += StringFormat("    \"setup_readiness_min_wait_score\": %d,\r\n", InpSetupReadinessMinWaitScore);
