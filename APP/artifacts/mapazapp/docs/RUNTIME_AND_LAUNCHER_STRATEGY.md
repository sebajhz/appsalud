...
- **D12.5 (solo documentación):** [`DASHBOARD_VISUAL_VERIFICATION_PLAN_D12.md`](./DASHBOARD_VISUAL_VERIFICATION_PLAN_D12.md) — plan de verificación **visual/humana** post-D12.3 (**sin** ejecutar API/dashboard en D12.5); ejecución ⇒ **D12.6** aprobada.
