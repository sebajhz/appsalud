...
- **E5 — Diseño campaña XAUUSD Strategy Tester (docs-only) — cerrado:** [`XAUUSD_STRATEGY_TESTER_CAMPAIGN_DESIGN_E5.md`](./XAUUSD_STRATEGY_TESTER_CAMPAIGN_DESIGN_E5.md) — Phase A (candidato/compuerta) vs Phase B (outcome); sin medir rentabilidad hasta motor acordado. **Siguiente:** **E5.1** — decisión modo outcome (virtual vs tester_orders).
