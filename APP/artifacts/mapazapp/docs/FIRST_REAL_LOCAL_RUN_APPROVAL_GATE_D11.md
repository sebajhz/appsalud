...
**Seguimiento D12:** el run **D12.0** (API-only supervisado) quedó **completado OK**; evidencia en [`API_ONLY_RUN_EVIDENCE_D12.md`](./API_ONLY_RUN_EVIDENCE_D12.md). El run **D12.3** (**API + dashboard**, dos procesos locales) quedó **completado OK**; evidencia en [`API_DASHBOARD_RUN_EVIDENCE_D12.md`](./API_DASHBOARD_RUN_EVIDENCE_D12.md) (**D12.4**). La **verificación visual real** en navegador (plan **D12.5**, ejecución **D12.6**) **no** queda implícita por los runs anteriores: requiere **nueva aprobación explícita** y ventana acotada. Cualquier **ampliación posterior** (más procesos, `dev-start`, MT5, acciones, etc.) sigue requiriendo **nueva aprobación explícita** y comando §2.9 literal actualizado; esta compuerta **no** autoriza automáticamente fases futuras.
