...
- **Siguiente paso canónico:** **E5.10.7** — smoke Strategy Tester post–**E5.10.6** (recompilar `MZP_TestEA_E5_10_6`, validar CLI, revisar `liquidity_chain_reaction_*`). **Nota:** el track opcional **`tester_orders`** (E5.1) queda **aparte**.
