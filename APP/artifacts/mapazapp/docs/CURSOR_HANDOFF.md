...
- **E5.14 cerrado (export repo):** [`IFVG_BISI_SIBI_EXPORT_E5_14.md`](./IFVG_BISI_SIBI_EXPORT_E5_14.md), build **`MZP_TestEA_E5_14`**. Clasificación BISI/SIBI/IFVG diagnóstica; **no** cambia entry 50 %/CE ni generación de trades. **Siguiente (operador):** compilar + smoke ST + validar bundle.
