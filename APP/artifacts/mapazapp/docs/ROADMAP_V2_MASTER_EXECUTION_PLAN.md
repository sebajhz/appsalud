...
- **E4 — Primer smoke Strategy Tester (manual):** plan operador + criterios + validación TS / gap bundle CLI — [`FIRST_MT5_STRATEGY_TESTER_SMOKE_RUN_E4.md`](./FIRST_MT5_STRATEGY_TESTER_SMOKE_RUN_E4.md); **no** automatización MT5 desde repo ni dashboard; evidencia post-run en `FIRST_MT5_STRATEGY_TESTER_SMOKE_RUN_E4_EVIDENCE.md` (commit aparte cuando exista).
