...
- **E5.15.1 cerrado (smoke operador):** [`LIQUIDITY_TARGET_QUALITY_SMOKE_EVIDENCE_E5_15_1.md`](./LIQUIDITY_TARGET_QUALITY_SMOKE_EVIDENCE_E5_15_1.md), build **`MZP_TestEA_E5_15`**, bundle `SET001_FVG2_RR2_00_BIASBODY0_RALIGN1` — PASS; TP oficial sin cambio; entry 50 %/CE sin cambio. **Siguiente:** **E5.16** session/spread/volatility **o** **E5.15.2** target realism audit (research). **Futuro:** Setup Readiness Checklist (North Star E5.18).
