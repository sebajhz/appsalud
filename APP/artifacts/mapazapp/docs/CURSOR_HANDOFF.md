...
- **E5.15.4 cerrado (policy research):** [`TARGET_POLICY_RESEARCH_E5_15_4.md`](./TARGET_POLICY_RESEARCH_E5_15_4.md) — bloque E5.15 cerrado a nivel política. **Siguiente:** **E5.16** session/spread/volatility. **Futuro:** Setup Readiness Checklist (North Star E5.18).
