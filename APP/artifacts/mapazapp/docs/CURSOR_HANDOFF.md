...
- Siguiente planificado: V2-13 (campaign runner sobre datasets manuales).
...
**Roadmap V2-12 — Export sample validation:** `validateExportSampleBundle` + privacidad heurística; see `APP/artifacts/mapazapp/docs/V2_12_REAL_EXPORT_SAMPLE_VALIDATION.md`. Further items per `ROADMAP_V2_MASTER_EXECUTION_PLAN.md` (e.g. V2-13).
