...
- **Siguiente paso canónico:** **E5.12.3** (smoke post–E5.12.2 en MT5 / operador) **o** **E5.13 — Premium/Discount V1** — roadmap [`PROFESSIONAL_TRADER_HUMANIZATION_ROADMAP_E5_11.md`](./PROFESSIONAL_TRADER_HUMANIZATION_ROADMAP_E5_11.md) §C–§D. **Nota:** el track opcional **`tester_orders`** (E5.1) queda **aparte**.
