...
El adaptador dashboard (**E5.20.3** — [`DASHBOARD_READONLY_DATA_ADAPTER_E5_20_3.md`](./DASHBOARD_READONLY_DATA_ADAPTER_E5_20_3.md); fix **E5.20.3.0.1** para `main_reason` contextual sin bloqueador duro) debe:
