...
- **Cabecera E5.10.2 (Liquidity Sweep Quality V1 — observación, sin gate):** inmediatamente después de `liquidity_event_reasons`, antes de `session_bucket`:  
  ...
  Con build **E5.10.2+**, `liquidity_event_score` en el CSV refleja el **total de calidad** (0–20) cuando el score de liquidez está habilitado; ver [`LIQUIDITY_SWEEP_QUALITY_REFINEMENT_E5_10_2.md`](../../../mapazapp/docs/LIQUIDITY_SWEEP_QUALITY_REFINEMENT_E5_10_2.md).  
