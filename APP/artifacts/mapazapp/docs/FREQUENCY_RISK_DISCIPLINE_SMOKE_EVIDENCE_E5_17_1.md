...
3. ~~**E5.18.2** Setup Readiness Decision Calibration Audit.~~ **Repo done** — [`SETUP_READINESS_DECISION_CALIBRATION_AUDIT_E5_18_2.md`](./SETUP_READINESS_DECISION_CALIBRATION_AUDIT_E5_18_2.md). ~~**E5.18.3** evidencia operador.~~ **Done** — [`SETUP_READINESS_DECISION_CALIBRATION_AUDIT_EVIDENCE_E5_18_3.md`](./SETUP_READINESS_DECISION_CALIBRATION_AUDIT_EVIDENCE_E5_18_3.md). **Siguiente:** E5.18.4 policy refinement.
