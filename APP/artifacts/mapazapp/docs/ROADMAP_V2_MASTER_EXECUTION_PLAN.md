...
- **Parameter / optimization governance:** [`MAPAZAPP_PARAMETER_AND_OPTIMIZATION_GOVERNANCE.md`](./MAPAZAPP_PARAMETER_AND_OPTIMIZATION_GOVERNANCE.md); perfiles símbolo E5.23 — [`OPTIMIZATION_GOVERNANCE_SYMBOL_PROFILES_E5_23.md`](./OPTIMIZATION_GOVERNANCE_SYMBOL_PROFILES_E5_23.md).
- **Humanized setup acceptance (E5.20.5):** [`HUMANIZED_SETUP_ACCEPTANCE_POLICY_V1_E5_20_5.md`](./HUMANIZED_SETUP_ACCEPTANCE_POLICY_V1_E5_20_5.md). **Casebook (E5.20.6):** [`HUMANIZED_ACCEPTANCE_CASEBOOK_E5_20_6.md`](./HUMANIZED_ACCEPTANCE_CASEBOOK_E5_20_6.md). **Adapter (E5.20.3):** [`DASHBOARD_READONLY_DATA_ADAPTER_E5_20_3.md`](./DASHBOARD_READONLY_DATA_ADAPTER_E5_20_3.md).
...
- **E5.22.0.1 (docs-only):** [`MT5_REPO_STRATEGY_ALIGNMENT_CHECK_E5_22_0_1.md`](./MT5_REPO_STRATEGY_ALIGNMENT_CHECK_E5_22_0_1.md).
- **E5.22 (evidencia PASS):** [`LATEST_TESTEA_MT5_ST_EVIDENCE_E5_22.md`](./LATEST_TESTEA_MT5_ST_EVIDENCE_E5_22.md).
- **E5.22.2 (repo):** [`SETUP_PERFORMANCE_BASELINE_AUDIT_E5_22_2.md`](./SETUP_PERFORMANCE_BASELINE_AUDIT_E5_22_2.md).
- **E5.22.2.1 (PASS):** [`SETUP_PERFORMANCE_BASELINE_AUDIT_EVIDENCE_E5_22_2_1.md`](./SETUP_PERFORMANCE_BASELINE_AUDIT_EVIDENCE_E5_22_2_1.md).
...
- **Cerrado (policy docs / governance):** [`HUMANIZED_SETUP_ACCEPTANCE_POLICY_V1_E5_20_5.md`](./HUMANIZED_SETUP_ACCEPTANCE_POLICY_V1_E5_20_5.md) — alinea North Star y roadmap E5.11+ con aceptación humanizada vs Detection/Readiness/Report V1; **sin** MQL5/TS/MT5/dashboard; entry **50 % / CE**; TP **RR2**; edge/25/adaptive research-only.
- **Siguiente:** revisión PM → E5.20.3 (tras E5.20.6).
...
- **Cerrado (smoke operador):** Liquidity Target Quality — [`LIQUIDITY_TARGET_QUALITY_SMOKE_EVIDENCE_E5_15_1.md`](./LIQUIDITY_TARGET_QUALITY_SMOKE_EVIDENCE_E5_15_1.md), build `MZP_TestEA_E5_15`, bundle `SET001_FVG2_RR2_00_BIASBODY0_RALIGN1`. PASS técnico; TP y entry oficial sin cambio.

## E5.15 checkpoint context

- **Cerrado (repo export):** Liquidity Target Quality V1 — [`LIQUIDITY_TARGET_QUALITY_EXPORT_E5_15.md`](./LIQUIDITY_TARGET_QUALITY_EXPORT_E5_15.md), build `MZP_TestEA_E5_15`.
- **Sin** aprobación edge; entry oficial 50 % / CE sin cambio.
...
- **E5.13.6.9 (docs) — cerrado:** [`EDGE_ENTRY_ROBUSTNESS_AUDIT_EVIDENCE_E5_13_6_9.md`](./EDGE_ENTRY_ROBUSTNESS_AUDIT_EVIDENCE_E5_13_6_9.md); bundle benchmark; PASS post-8.1; edge frágil; **no** aprobar edge.
...
- **E5.20 alignment:** E5.20 cerrado; **E5.22** PASS; **E5.21.3+** pausado; **E5.22.1+** motor prioritario.
...
- **E5.20 alignment:** fase 1 file-based index (E5.20 §9); fase 2 SQLite metadata-only — mismo plan E5.20.
