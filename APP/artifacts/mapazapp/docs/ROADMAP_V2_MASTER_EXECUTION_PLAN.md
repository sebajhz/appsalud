...
- **E5.2 — Contrato simulación virtual (docs-only) — cerrado:** [`TESTEA_VIRTUAL_TRADE_SIMULATION_CONTRACT_E5_2.md`](./TESTEA_VIRTUAL_TRADE_SIMULATION_CONTRACT_E5_2.md) — lifecycle, entry/SL/TP, fill, expiries, ambigüedad `ambiguous`, una operación activa, impacto exports. **Siguiente:** **E5.3** — implementación MQL5 + exports.
