...
- **E5.10.4 (repo):** **Causal Liquidity Chain V1** — `MZP_TestEA_E5_10_4`, columnas `liquidity_chain_*`, `has_liquidity_chain_v1_logic`; observación-only; `liquidity_event_score` sigue cadena cuando aplicable — [`LIQUIDITY_CHAIN_REFINEMENT_E5_10_4.md`](./LIQUIDITY_CHAIN_REFINEMENT_E5_10_4.md).
