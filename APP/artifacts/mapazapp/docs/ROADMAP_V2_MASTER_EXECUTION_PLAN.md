...
- **E4 — Primer smoke Strategy Tester (manual) — cerrado con evidencia:** plan [`FIRST_MT5_STRATEGY_TESTER_SMOKE_RUN_E4.md`](./FIRST_MT5_STRATEGY_TESTER_SMOKE_RUN_E4.md); evidencia real **OK with observations** [`FIRST_MT5_STRATEGY_TESTER_SMOKE_RUN_E4_EVIDENCE.md`](./FIRST_MT5_STRATEGY_TESTER_SMOKE_RUN_E4_EVIDENCE.md). Opcional **E4.1** — validación CLI/workflow bundle real; siguiente fase principal **E5** — campaña XAUUSD tester.
