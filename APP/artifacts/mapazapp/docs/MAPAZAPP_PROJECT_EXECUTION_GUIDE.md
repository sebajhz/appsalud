...
- **Siguiente operativo / investigación:** **E5.13.1 — smoke Premium/Discount** (operador; post-recompile) sobre bundle representativo; luego continuar roadmap §E (`PROFESSIONAL_TRADER_HUMANIZATION_ROADMAP_E5_11.md`).
