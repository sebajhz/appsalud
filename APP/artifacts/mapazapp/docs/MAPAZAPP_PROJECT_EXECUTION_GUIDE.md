...
- **Siguiente operativo:** **E5.9** — **calibración y distribución** del score (percentiles, outcome, `ambiguous`, FVGMin, componentes faltantes); **sin** aprobación de umbrales; cadena E5.10–E5.13 en roadmap y handoff.
...
| E5.9 | Score **calibración / distribución** (campaña o agregados off-line) | pending | Operador + Cursor | Percentiles, outcome/`ambiguous`, FVGMin, frecuencia faltantes; **sin** umbral aprobado — ver **E5.8.1** §8. | **E5.10** |
...
| E5.8.1 | Entry Quality Score smoke evidence + calibration caveat (operator) | `ENTRY_QUALITY_SCORE_SMOKE_EVIDENCE_E5_8_1.md`, refs E5.8 / contrato / audit / guía / handoff / roadmap | PASS técnico export; A/B=0 interpretación calibración; gate no aprobado | **E5.9** calibración |
