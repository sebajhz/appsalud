...
| E5.12 | **MSS / CHoCH V1** export (execution TF observation) | **completed** | Cursor | `Mapazapp_TestEA.mq5` **`MZP_TestEA_E5_12`**, columnas/summary/eventos (`msc_en`), core importer + validador + calibración opcional `mss_choch_score` — [`MSS_CHOCH_EXPORT_E5_12.md`](./MSS_CHOCH_EXPORT_E5_12.md). | **E5.12.1** |
| E5.12.1 | MSS / CHoCH **smoke evidence** (operator; post–E5.12) | **completed** | Operador + Cursor | Smoke `MZP_TestEA_E5_12`; PASS técnico; score V1 no separa wins/losses; observación-only — [`MSS_CHOCH_SMOKE_EVIDENCE_E5_12_1.md`](./MSS_CHOCH_SMOKE_EVIDENCE_E5_12_1.md). | **E5.12.2** / **E5.13** |
...
| E5.12.1 | MSS/CHoCH smoke evidence (docs-only; operador) | `MSS_CHOCH_SMOKE_EVIDENCE_E5_12_1.md`, refs export E5.12 / roadmap E5.11 §C | PASS técnico; MSS/CHoCH útil como diagnóstico; sin compuerta; sin tune por un bundle | **E5.12.2** / **E5.13** |
