...
| E5.11 | **HTF Structure V1** export (TestEA observation) | **completed** | Cursor | `Mapazapp_TestEA.mq5` **`MZP_TestEA_E5_11`**, columnas/summary/eventos, core TS, muestras, validador — [`HTF_STRUCTURE_EXPORT_E5_11.md`](./HTF_STRUCTURE_EXPORT_E5_11.md). | **E5.11.1** smoke |
...
| Humanización roadmap | Roadmap intermedio trader profesional E5.11–E5.19 (docs-only) | `PROFESSIONAL_TRADER_HUMANIZATION_ROADMAP_E5_11.md`, refs `ROADMAP_V2_MASTER_EXECUTION_PLAN.md`, `CURSOR_HANDOFF.md`, evidencia E5.10.7 | Secuencia observación-first; E5.11 export cerrado en repo | **E5.11.1** smoke → **E5.12** |
