...
- **E5.17.2 cerrado (policy):** [`OPTIMIZATION_GOVERNANCE_AND_VISUAL_REVIEW_POLICY_E5_17_2.md`](./OPTIMIZATION_GOVERNANCE_AND_VISUAL_REVIEW_POLICY_E5_17_2.md) — optimización multi-perfil, anti-overfit, MT5 genético solo investigación, Visual Trace futuro; **sin** código/parámetros. **Siguiente:** E5.17.1 smoke (operador); E5.18 checklist.
