...
**Roadmap V2-13 — Manual dataset campaign pipeline:** `runManualDatasetCampaign`; see `APP/artifacts/mapazapp/docs/V2_13_CAMPAIGN_RUNNER_OVER_MANUAL_DATASETS.md`. Further items per `ROADMAP_V2_MASTER_EXECUTION_PLAN.md` (e.g. V2-14).
