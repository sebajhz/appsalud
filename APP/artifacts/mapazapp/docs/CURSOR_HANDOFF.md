...
- Siguiente planificado: V2-15 (walk-forward / train-validation-forward).
...
**Roadmap V2-14 — Parameter set grid runner:** `runParameterGrid`; see `APP/artifacts/mapazapp/docs/V2_14_PARAMETER_SET_GRID_RUNNER_V1.md`. Further items per `ROADMAP_V2_MASTER_EXECUTION_PLAN.md` (e.g. V2-15).
