...
**Roadmap V2-07 — HTF bias / context:** `evaluateContextBias` + optional `DecisionModelInput.contextBiasResult` / `contextBiasIntegration`; optional `IfvgReplayBacktestInput.htfCandlesByTimeframe`; see `APP/artifacts/mapazapp/docs/V2_07_HTF_BIAS_CONTEXT_ENGINE_V1.md`. Next engine step suggested: **V2-08** (per `CP18_5_FINAL_AUDIT_AND_ROADMAP_V2.md`).
